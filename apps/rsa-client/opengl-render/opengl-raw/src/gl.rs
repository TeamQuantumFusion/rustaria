...
pub unsafe fn CheckNamedFramebufferStatus(framebuffer: GLuint, target: GLenum) -> GLenum {
    _CheckNamedFramebufferStatus(framebuffer, target)
}
...
pub unsafe fn ClearBufferData(
    ...
    _ClearBufferData(target, internalformat, format, type_, data)
}
pub unsafe fn ClearBufferSubData(
    ...
    _ClearBufferSubData(target, internalformat, offset, size, format, type_, data)
}
...
pub unsafe fn ClearNamedBufferData(
    ...
    _ClearNamedBufferData(buffer, internalformat, format, type_, data)
}
pub unsafe fn ClearNamedBufferSubData(
    ...
    _ClearNamedBufferSubData(buffer, internalformat, offset, size, format, type_, data)
}
...
pub unsafe fn ClearTexImage(
    ...
    _ClearTexImage(texture, level, format, type_, data)
}
...
pub unsafe fn CreateShaderProgramv(
    ...
    _CreateShaderProgramv(type_, count, strings)
}
...
pub unsafe fn DebugMessageControl(
    ...
    _DebugMessageControl(source, type_, severity, count, ids, enabled)
}
pub unsafe fn DebugMessageInsert(
    ...
    _DebugMessageInsert(source, type_, id, severity, length, buf)
}
...
pub unsafe fn DrawElements(mode: GLenum, count: GLsizei, type_: GLenum, indices: *const c_void) {
    _DrawElements(mode, count, type_, indices)
}
pub unsafe fn DrawElementsBaseVertex(
    ...
    _DrawElementsBaseVertex(mode, count, type_, indices, basevertex)
}
pub unsafe fn DrawElementsIndirect(mode: GLenum, type_: GLenum, indirect: *const c_void) {
    _DrawElementsIndirect(mode, type_, indirect)
}
pub unsafe fn DrawElementsInstanced(
    ...
    _DrawElementsInstanced(mode, count, type_, indices, instancecount)
}
pub unsafe fn DrawElementsInstancedBaseInstance(
    ...
    _DrawElementsInstancedBaseInstance(mode, count, type_, indices, instancecount, baseinstance)
}
pub unsafe fn DrawElementsInstancedBaseVertex(
    ...
    _DrawElementsInstancedBaseVertex(mode, count, type_, indices, instancecount, basevertex)
}
...
pub unsafe fn DrawRangeElements(
    ...
    _DrawRangeElements(mode, start, end, count, type_, indices)
}
pub unsafe fn DrawRangeElementsBaseVertex(
    ...
    _DrawRangeElementsBaseVertex(mode, start, end, count, type_, indices, basevertex)
}
...
pub unsafe fn GetActiveAttrib(
    ...
    _GetActiveAttrib(program, index, bufSize, length, size, type_, name)
}
...
pub unsafe fn GetActiveUniform(
    ...
    _GetActiveUniform(program, index, bufSize, length, size, type_, name)
}
...
pub unsafe fn GetProgramResourceLocation(
    ...
    _GetProgramResourceLocation(program, programInterface, name)
}
pub unsafe fn GetProgramResourceLocationIndex(
    ...
    _GetProgramResourceLocationIndex(program, programInterface, name)
}
...
pub unsafe fn GetSubroutineIndex(
    ...
    _GetSubroutineIndex(program, shadertype, name)
}
pub unsafe fn GetSubroutineUniformLocation(
    ...
    _GetSubroutineUniformLocation(program, shadertype, name)
}
...
pub unsafe fn GetTexImage(
    ...
    _GetTexImage(target, level, format, type_, pixels)
}
...
pub unsafe fn GetTextureImage(
    ...
    _GetTextureImage(texture, level, format, type_, bufSize, pixels)
}
...
pub unsafe fn GetTransformFeedbackVarying(
    ...
    _GetTransformFeedbackVarying(program, index, bufSize, length, size, type_, name)
}
...
pub unsafe fn GetnColorTable(
    ...
    _GetnColorTable(target, format, type_, bufSize, table)
}
...
pub unsafe fn GetnConvolutionFilter(
    ...
    _GetnConvolutionFilter(target, format, type_, bufSize, image)
}
...
pub unsafe fn GetnTexImage(
    ...
    _GetnTexImage(target, level, format, type_, bufSize, pixels)
}
...
pub unsafe fn InvalidateNamedFramebufferSubData(
    ...
    _InvalidateNamedFramebufferSubData(
        framebuffer,
        numAttachments,
        attachments,
        x,
...
pub unsafe fn MapNamedBufferRange(
    ...
    _MapNamedBufferRange(buffer, offset, length, access)
}
...
pub unsafe fn MultiDrawElements(
    ...
    _MultiDrawElements(mode, count, type_, indices, drawcount)
}
pub unsafe fn MultiDrawElementsBaseVertex(
    ...
    _MultiDrawElementsBaseVertex(mode, count, type_, indices, drawcount, basevertex)
}
pub unsafe fn MultiDrawElementsIndirect(
    ...
    _MultiDrawElementsIndirect(mode, type_, indirect, drawcount, stride)
}
...
pub unsafe fn PolygonOffsetClamp(factor: GLfloat, units: GLfloat, clamp: GLfloat) {
...
pub unsafe fn ReadPixels(
    ...
    _ReadPixels(x, y, width, height, format, type_, pixels)
}
pub unsafe fn ReadnPixels(
    ...
    _ReadnPixels(x, y, width, height, format, type_, bufSize, data)
}
...
pub unsafe fn TexSubImage1D(
    ...
    _TexSubImage1D(target, level, xoffset, width, format, type_, pixels)
}
...
pub unsafe fn TextureSubImage1D(
    ...
    _TextureSubImage1D(texture, level, xoffset, width, format, type_, pixels)
}
...
pub unsafe fn VertexArrayAttribFormat(
    ...
    _VertexArrayAttribFormat(vaobj, attribindex, size, type_, normalized, relativeoffset)
}
pub unsafe fn VertexArrayAttribIFormat(
    ...
    _VertexArrayAttribIFormat(vaobj, attribindex, size, type_, relativeoffset)
}
pub unsafe fn VertexArrayAttribLFormat(
    ...
    _VertexArrayAttribLFormat(vaobj, attribindex, size, type_, relativeoffset)
}
...
pub unsafe fn VertexAttribFormat(
    ...
    _VertexAttribFormat(attribindex, size, type_, normalized, relativeoffset)
}
...
pub unsafe fn VertexAttribIFormat(
    ...
    _VertexAttribIFormat(attribindex, size, type_, relativeoffset)
}
pub unsafe fn VertexAttribIPointer(
    ...
    _VertexAttribIPointer(index, size, type_, stride, pointer)
}
...
pub unsafe fn VertexAttribLFormat(
    ...
    _VertexAttribLFormat(attribindex, size, type_, relativeoffset)
}
pub unsafe fn VertexAttribLPointer(
    ...
    _VertexAttribLPointer(index, size, type_, stride, pointer)
}
pub unsafe fn VertexAttribP1ui(index: GLuint, type_: GLenum, normalized: GLboolean, value: GLuint) {
    _VertexAttribP1ui(index, type_, normalized, value)
}
pub unsafe fn VertexAttribP1uiv(
    ...
    _VertexAttribP1uiv(index, type_, normalized, value)
}
pub unsafe fn VertexAttribP2ui(index: GLuint, type_: GLenum, normalized: GLboolean, value: GLuint) {
    _VertexAttribP2ui(index, type_, normalized, value)
}
pub unsafe fn VertexAttribP2uiv(
    ...
    _VertexAttribP2uiv(index, type_, normalized, value)
}
pub unsafe fn VertexAttribP3ui(index: GLuint, type_: GLenum, normalized: GLboolean, value: GLuint) {
    _VertexAttribP3ui(index, type_, normalized, value)
}
pub unsafe fn VertexAttribP3uiv(
    ...
    _VertexAttribP3uiv(index, type_, normalized, value)
}
pub unsafe fn VertexAttribP4ui(index: GLuint, type_: GLenum, normalized: GLboolean, value: GLuint) {
    _VertexAttribP4ui(index, type_, normalized, value)
}
pub unsafe fn VertexAttribP4uiv(
    ...
    _VertexAttribP4uiv(index, type_, normalized, value)
}
pub unsafe fn VertexAttribPointer(
    ...
    _VertexAttribPointer(index, size, type_, normalized, stride, pointer)
}
...
static mut _BeginQueryIndexed: extern "system" fn(GLenum, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _BeginTransformFeedback: extern "system" fn(GLenum) = unsafe { transmute(ERR) };
static mut _BindAttribLocation: extern "system" fn(GLuint, GLuint, *const GLchar) =
    unsafe { transmute(ERR) };
...
static mut _BindBufferRange: extern "system" fn(GLenum, GLuint, GLuint, GLintptr, GLsizeiptr) =
    unsafe { transmute(ERR) };
static mut _BindBuffersBase: extern "system" fn(GLenum, GLuint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _BindBuffersRange: extern "system" fn(
    GLenum,
    GLuint,
    GLsizei,
    *const GLuint,
...
static mut _BindFragDataLocation: extern "system" fn(GLuint, GLuint, *const GLchar) =
    unsafe { transmute(ERR) };
static mut _BindFragDataLocationIndexed: extern "system" fn(GLuint, GLuint, GLuint, *const GLchar) =
    unsafe { transmute(ERR) };
static mut _BindFramebuffer: extern "system" fn(GLenum, GLuint) = unsafe { transmute(ERR) };
static mut _BindImageTexture: extern "system" fn(
    GLuint,
    GLuint,
    GLint,
    GLboolean,
...
static mut _BindImageTextures: extern "system" fn(GLuint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
...
static mut _BindSamplers: extern "system" fn(GLuint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
...
static mut _BindTextures: extern "system" fn(GLuint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
...
static mut _BindVertexBuffer: extern "system" fn(GLuint, GLuint, GLintptr, GLsizei) =
    unsafe { transmute(ERR) };
static mut _BindVertexBuffers: extern "system" fn(
    GLuint,
    GLsizei,
    *const GLuint,
    *const GLintptr,
...
static mut _BlendColor: extern "system" fn(GLfloat, GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
...
static mut _BlendEquationSeparatei: extern "system" fn(GLuint, GLenum, GLenum) =
    unsafe { transmute(ERR) };
...
static mut _BlendFuncSeparate: extern "system" fn(GLenum, GLenum, GLenum, GLenum) =
    unsafe { transmute(ERR) };
static mut _BlendFuncSeparatei: extern "system" fn(GLuint, GLenum, GLenum, GLenum, GLenum) =
    unsafe { transmute(ERR) };
static mut _BlendFunci: extern "system" fn(GLuint, GLenum, GLenum) = unsafe { transmute(ERR) };
static mut _BlitFramebuffer: extern "system" fn(
    GLint,
    GLint,
    GLint,
    GLint,
...
static mut _BlitNamedFramebuffer: extern "system" fn(
    GLuint,
    GLuint,
    GLint,
    GLint,
...
static mut _BufferData: extern "system" fn(GLenum, GLsizeiptr, *const c_void, GLenum) =
    unsafe { transmute(ERR) };
static mut _BufferStorage: extern "system" fn(GLenum, GLsizeiptr, *const c_void, GLbitfield) =
    unsafe { transmute(ERR) };
static mut _BufferSubData: extern "system" fn(GLenum, GLintptr, GLsizeiptr, *const c_void) =
    unsafe { transmute(ERR) };
static mut _CheckFramebufferStatus: extern "system" fn(GLenum) -> GLenum =
    unsafe { transmute(ERR) };
static mut _CheckNamedFramebufferStatus: extern "system" fn(GLuint, GLenum) -> GLenum =
    unsafe { transmute(ERR) };
...
static mut _ClearBufferData: extern "system" fn(GLenum, GLenum, GLenum, GLenum, *const c_void) =
    unsafe { transmute(ERR) };
static mut _ClearBufferSubData: extern "system" fn(
    GLenum,
    GLenum,
    GLintptr,
    GLsizeiptr,
...
static mut _ClearBufferfi: extern "system" fn(GLenum, GLint, GLfloat, GLint) =
    unsafe { transmute(ERR) };
static mut _ClearBufferfv: extern "system" fn(GLenum, GLint, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _ClearBufferiv: extern "system" fn(GLenum, GLint, *const GLint) =
    unsafe { transmute(ERR) };
static mut _ClearBufferuiv: extern "system" fn(GLenum, GLint, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _ClearColor: extern "system" fn(GLfloat, GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
...
static mut _ClearNamedBufferData: extern "system" fn(
    GLuint,
    GLenum,
    GLenum,
    GLenum,
...
static mut _ClearNamedBufferSubData: extern "system" fn(
    GLuint,
    GLenum,
    GLintptr,
    GLsizeiptr,
...
static mut _ClearNamedFramebufferfi: extern "system" fn(GLuint, GLenum, GLint, GLfloat, GLint) =
    unsafe { transmute(ERR) };
static mut _ClearNamedFramebufferfv: extern "system" fn(GLuint, GLenum, GLint, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _ClearNamedFramebufferiv: extern "system" fn(GLuint, GLenum, GLint, *const GLint) =
    unsafe { transmute(ERR) };
static mut _ClearNamedFramebufferuiv: extern "system" fn(GLuint, GLenum, GLint, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _ClearStencil: extern "system" fn(GLint) = unsafe { transmute(ERR) };
static mut _ClearTexImage: extern "system" fn(GLuint, GLint, GLenum, GLenum, *const c_void) =
    unsafe { transmute(ERR) };
static mut _ClearTexSubImage: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _ClientWaitSync: extern "system" fn(GLsync, GLbitfield, GLuint64) -> GLenum =
    unsafe { transmute(ERR) };
static mut _ClipControl: extern "system" fn(GLenum, GLenum) = unsafe { transmute(ERR) };
static mut _ColorMask: extern "system" fn(GLboolean, GLboolean, GLboolean, GLboolean) =
    unsafe { transmute(ERR) };
static mut _ColorMaski: extern "system" fn(GLuint, GLboolean, GLboolean, GLboolean, GLboolean) =
    unsafe { transmute(ERR) };
...
static mut _CompressedTexImage1D: extern "system" fn(
    GLenum,
    GLint,
    GLenum,
    GLsizei,
...
static mut _CompressedTexImage2D: extern "system" fn(
    GLenum,
    GLint,
    GLenum,
    GLsizei,
...
static mut _CompressedTexImage3D: extern "system" fn(
    GLenum,
    GLint,
    GLenum,
    GLsizei,
...
static mut _CompressedTexSubImage1D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLsizei,
...
static mut _CompressedTexSubImage2D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLint,
...
static mut _CompressedTexSubImage3D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLint,
...
static mut _CompressedTextureSubImage1D: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLsizei,
...
static mut _CompressedTextureSubImage2D: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _CompressedTextureSubImage3D: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _CopyBufferSubData: extern "system" fn(GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr) =
    unsafe { transmute(ERR) };
static mut _CopyImageSubData: extern "system" fn(
    GLuint,
    GLenum,
    GLint,
    GLint,
...
static mut _CopyNamedBufferSubData: extern "system" fn(
    GLuint,
    GLuint,
    GLintptr,
    GLintptr,
...
static mut _CopyTexImage1D: extern "system" fn(
    GLenum,
    GLint,
    GLenum,
    GLint,
...
static mut _CopyTexImage2D: extern "system" fn(
    GLenum,
    GLint,
    GLenum,
    GLint,
...
static mut _CopyTexSubImage1D: extern "system" fn(GLenum, GLint, GLint, GLint, GLint, GLsizei) =
    unsafe { transmute(ERR) };
static mut _CopyTexSubImage2D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLint,
...
static mut _CopyTexSubImage3D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLint,
...
static mut _CopyTextureSubImage1D: extern "system" fn(GLuint, GLint, GLint, GLint, GLint, GLsizei) =
    unsafe { transmute(ERR) };
static mut _CopyTextureSubImage2D: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _CopyTextureSubImage3D: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _CreateFramebuffers: extern "system" fn(GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _CreateProgram: extern "system" fn() -> GLuint = unsafe { transmute(ERR) };
static mut _CreateProgramPipelines: extern "system" fn(GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _CreateQueries: extern "system" fn(GLenum, GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _CreateRenderbuffers: extern "system" fn(GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
...
static mut _CreateShaderProgramv: extern "system" fn(
    GLenum,
    GLsizei,
    *const *const GLchar,
) -> GLuint = unsafe { transmute(ERR) };
static mut _CreateTextures: extern "system" fn(GLenum, GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _CreateTransformFeedbacks: extern "system" fn(GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _CreateVertexArrays: extern "system" fn(GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _CullFace: extern "system" fn(GLenum) = unsafe { transmute(ERR) };
static mut _DebugMessageCallback: extern "system" fn(GLDEBUGPROC, *const c_void) =
    unsafe { transmute(ERR) };
static mut _DebugMessageControl: extern "system" fn(
    GLenum,
    GLenum,
    GLenum,
    GLsizei,
...
static mut _DebugMessageInsert: extern "system" fn(
    GLenum,
    GLenum,
    GLuint,
    GLenum,
...
static mut _DeleteFramebuffers: extern "system" fn(GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _DeleteProgram: extern "system" fn(GLuint) = unsafe { transmute(ERR) };
static mut _DeleteProgramPipelines: extern "system" fn(GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _DeleteQueries: extern "system" fn(GLsizei, *const GLuint) = unsafe { transmute(ERR) };
static mut _DeleteRenderbuffers: extern "system" fn(GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
...
static mut _DeleteTransformFeedbacks: extern "system" fn(GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _DeleteVertexArrays: extern "system" fn(GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
...
static mut _DepthRangeArrayv: extern "system" fn(GLuint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _DepthRangeIndexed: extern "system" fn(GLuint, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
...
static mut _DisableVertexArrayAttrib: extern "system" fn(GLuint, GLuint) =
    unsafe { transmute(ERR) };
...
static mut _DrawArraysIndirect: extern "system" fn(GLenum, *const c_void) =
    unsafe { transmute(ERR) };
static mut _DrawArraysInstanced: extern "system" fn(GLenum, GLint, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _DrawArraysInstancedBaseInstance: extern "system" fn(
    GLenum,
    GLint,
    GLsizei,
    GLsizei,
...
static mut _DrawElements: extern "system" fn(GLenum, GLsizei, GLenum, *const c_void) =
    unsafe { transmute(ERR) };
static mut _DrawElementsBaseVertex: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    *const c_void,
...
static mut _DrawElementsIndirect: extern "system" fn(GLenum, GLenum, *const c_void) =
    unsafe { transmute(ERR) };
static mut _DrawElementsInstanced: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    *const c_void,
...
static mut _DrawElementsInstancedBaseInstance: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    *const c_void,
...
static mut _DrawElementsInstancedBaseVertex: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    *const c_void,
...
static mut _DrawElementsInstancedBaseVertexBaseInstance: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    *const c_void,
...
static mut _DrawRangeElements: extern "system" fn(
    GLenum,
    GLuint,
    GLuint,
    GLsizei,
...
static mut _DrawRangeElementsBaseVertex: extern "system" fn(
    GLenum,
    GLuint,
    GLuint,
    GLsizei,
...
static mut _DrawTransformFeedbackInstanced: extern "system" fn(GLenum, GLuint, GLsizei) =
    unsafe { transmute(ERR) };
static mut _DrawTransformFeedbackStream: extern "system" fn(GLenum, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _DrawTransformFeedbackStreamInstanced: extern "system" fn(
    GLenum,
    GLuint,
    GLuint,
    GLsizei,
...
static mut _FlushMappedBufferRange: extern "system" fn(GLenum, GLintptr, GLsizeiptr) =
    unsafe { transmute(ERR) };
static mut _FlushMappedNamedBufferRange: extern "system" fn(GLuint, GLintptr, GLsizeiptr) =
    unsafe { transmute(ERR) };
static mut _FramebufferParameteri: extern "system" fn(GLenum, GLenum, GLint) =
    unsafe { transmute(ERR) };
static mut _FramebufferRenderbuffer: extern "system" fn(GLenum, GLenum, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _FramebufferTexture: extern "system" fn(GLenum, GLenum, GLuint, GLint) =
    unsafe { transmute(ERR) };
static mut _FramebufferTexture1D: extern "system" fn(GLenum, GLenum, GLenum, GLuint, GLint) =
    unsafe { transmute(ERR) };
static mut _FramebufferTexture2D: extern "system" fn(GLenum, GLenum, GLenum, GLuint, GLint) =
    unsafe { transmute(ERR) };
static mut _FramebufferTexture3D: extern "system" fn(GLenum, GLenum, GLenum, GLuint, GLint, GLint) =
    unsafe { transmute(ERR) };
static mut _FramebufferTextureLayer: extern "system" fn(GLenum, GLenum, GLuint, GLint, GLint) =
    unsafe { transmute(ERR) };
...
static mut _GenProgramPipelines: extern "system" fn(GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
...
static mut _GenTransformFeedbacks: extern "system" fn(GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
...
static mut _GetActiveAtomicCounterBufferiv: extern "system" fn(GLuint, GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetActiveAttrib: extern "system" fn(
    GLuint,
    GLuint,
    GLsizei,
    *mut GLsizei,
...
static mut _GetActiveSubroutineName: extern "system" fn(
    GLuint,
    GLenum,
    GLuint,
    GLsizei,
...
static mut _GetActiveSubroutineUniformName: extern "system" fn(
    GLuint,
    GLenum,
    GLuint,
    GLsizei,
...
static mut _GetActiveSubroutineUniformiv: extern "system" fn(
    GLuint,
    GLenum,
    GLuint,
    GLenum,
...
static mut _GetActiveUniform: extern "system" fn(
    GLuint,
    GLuint,
    GLsizei,
    *mut GLsizei,
...
static mut _GetActiveUniformBlockName: extern "system" fn(
    GLuint,
    GLuint,
    GLsizei,
    *mut GLsizei,
...
static mut _GetActiveUniformBlockiv: extern "system" fn(GLuint, GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetActiveUniformName: extern "system" fn(
    GLuint,
    GLuint,
    GLsizei,
    *mut GLsizei,
...
static mut _GetActiveUniformsiv: extern "system" fn(
    GLuint,
    GLsizei,
    *const GLuint,
    GLenum,
...
static mut _GetAttachedShaders: extern "system" fn(GLuint, GLsizei, *mut GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetAttribLocation: extern "system" fn(GLuint, *const GLchar) -> GLint =
    unsafe { transmute(ERR) };
static mut _GetBooleani_v: extern "system" fn(GLenum, GLuint, *mut GLboolean) =
    unsafe { transmute(ERR) };
static mut _GetBooleanv: extern "system" fn(GLenum, *mut GLboolean) = unsafe { transmute(ERR) };
static mut _GetBufferParameteri64v: extern "system" fn(GLenum, GLenum, *mut GLint64) =
    unsafe { transmute(ERR) };
static mut _GetBufferParameteriv: extern "system" fn(GLenum, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetBufferPointerv: extern "system" fn(GLenum, GLenum, *const *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetBufferSubData: extern "system" fn(GLenum, GLintptr, GLsizeiptr, *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetCompressedTexImage: extern "system" fn(GLenum, GLint, *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetCompressedTextureImage: extern "system" fn(GLuint, GLint, GLsizei, *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetCompressedTextureSubImage: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _GetDebugMessageLog: extern "system" fn(
    GLuint,
    GLsizei,
    *mut GLenum,
    *mut GLenum,
...
static mut _GetDoublei_v: extern "system" fn(GLenum, GLuint, *mut GLdouble) =
    unsafe { transmute(ERR) };
...
static mut _GetFloati_v: extern "system" fn(GLenum, GLuint, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetFloatv: extern "system" fn(GLenum, *mut GLfloat) = unsafe { transmute(ERR) };
static mut _GetFragDataIndex: extern "system" fn(GLuint, *const GLchar) -> GLint =
    unsafe { transmute(ERR) };
static mut _GetFragDataLocation: extern "system" fn(GLuint, *const GLchar) -> GLint =
    unsafe { transmute(ERR) };
static mut _GetFramebufferAttachmentParameteriv: extern "system" fn(
    GLenum,
    GLenum,
    GLenum,
    *mut GLint,
) = unsafe { transmute(ERR) };
static mut _GetFramebufferParameteriv: extern "system" fn(GLenum, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetGraphicsResetStatus: extern "system" fn() -> GLenum = unsafe { transmute(ERR) };
static mut _GetInteger64i_v: extern "system" fn(GLenum, GLuint, *mut GLint64) =
    unsafe { transmute(ERR) };
static mut _GetInteger64v: extern "system" fn(GLenum, *mut GLint64) = unsafe { transmute(ERR) };
static mut _GetIntegeri_v: extern "system" fn(GLenum, GLuint, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetIntegerv: extern "system" fn(GLenum, *mut GLint) = unsafe { transmute(ERR) };
static mut _GetInternalformati64v: extern "system" fn(
    GLenum,
    GLenum,
    GLenum,
    GLsizei,
...
static mut _GetInternalformativ: extern "system" fn(GLenum, GLenum, GLenum, GLsizei, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetMultisamplefv: extern "system" fn(GLenum, GLuint, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetNamedBufferParameteri64v: extern "system" fn(GLuint, GLenum, *mut GLint64) =
    unsafe { transmute(ERR) };
static mut _GetNamedBufferParameteriv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetNamedBufferPointerv: extern "system" fn(GLuint, GLenum, *const *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetNamedBufferSubData: extern "system" fn(GLuint, GLintptr, GLsizeiptr, *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetNamedFramebufferAttachmentParameteriv: extern "system" fn(
    GLuint,
    GLenum,
    GLenum,
    *mut GLint,
) = unsafe { transmute(ERR) };
static mut _GetNamedFramebufferParameteriv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetNamedRenderbufferParameteriv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetObjectLabel: extern "system" fn(GLenum, GLuint, GLsizei, *mut GLsizei, *mut GLchar) =
    unsafe { transmute(ERR) };
static mut _GetObjectPtrLabel: extern "system" fn(
    *const c_void,
    GLsizei,
    *mut GLsizei,
    *mut GLchar,
...
static mut _GetProgramBinary: extern "system" fn(
    GLuint,
    GLsizei,
    *mut GLsizei,
    *mut GLenum,
...
static mut _GetProgramInfoLog: extern "system" fn(GLuint, GLsizei, *mut GLsizei, *mut GLchar) =
    unsafe { transmute(ERR) };
static mut _GetProgramInterfaceiv: extern "system" fn(GLuint, GLenum, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetProgramPipelineInfoLog: extern "system" fn(
    GLuint,
    GLsizei,
    *mut GLsizei,
    *mut GLchar,
) = unsafe { transmute(ERR) };
static mut _GetProgramPipelineiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetProgramResourceIndex: extern "system" fn(GLuint, GLenum, *const GLchar) -> GLuint =
    unsafe { transmute(ERR) };
static mut _GetProgramResourceLocation: extern "system" fn(GLuint, GLenum, *const GLchar) -> GLint =
    unsafe { transmute(ERR) };
static mut _GetProgramResourceLocationIndex: extern "system" fn(
    GLuint,
    GLenum,
    *const GLchar,
) -> GLint = unsafe { transmute(ERR) };
static mut _GetProgramResourceName: extern "system" fn(
    GLuint,
    GLenum,
    GLuint,
    GLsizei,
...
static mut _GetProgramResourceiv: extern "system" fn(
    GLuint,
    GLenum,
    GLuint,
    GLsizei,
...
static mut _GetProgramStageiv: extern "system" fn(GLuint, GLenum, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetProgramiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetQueryBufferObjecti64v: extern "system" fn(GLuint, GLuint, GLenum, GLintptr) =
    unsafe { transmute(ERR) };
static mut _GetQueryBufferObjectiv: extern "system" fn(GLuint, GLuint, GLenum, GLintptr) =
    unsafe { transmute(ERR) };
static mut _GetQueryBufferObjectui64v: extern "system" fn(GLuint, GLuint, GLenum, GLintptr) =
    unsafe { transmute(ERR) };
static mut _GetQueryBufferObjectuiv: extern "system" fn(GLuint, GLuint, GLenum, GLintptr) =
    unsafe { transmute(ERR) };
static mut _GetQueryIndexediv: extern "system" fn(GLenum, GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetQueryObjecti64v: extern "system" fn(GLuint, GLenum, *mut GLint64) =
    unsafe { transmute(ERR) };
static mut _GetQueryObjectiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetQueryObjectui64v: extern "system" fn(GLuint, GLenum, *mut GLuint64) =
    unsafe { transmute(ERR) };
static mut _GetQueryObjectuiv: extern "system" fn(GLuint, GLenum, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetQueryiv: extern "system" fn(GLenum, GLenum, *mut GLint) = unsafe { transmute(ERR) };
static mut _GetRenderbufferParameteriv: extern "system" fn(GLenum, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetSamplerParameterIiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetSamplerParameterIuiv: extern "system" fn(GLuint, GLenum, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetSamplerParameterfv: extern "system" fn(GLuint, GLenum, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetSamplerParameteriv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetShaderInfoLog: extern "system" fn(GLuint, GLsizei, *mut GLsizei, *mut GLchar) =
    unsafe { transmute(ERR) };
static mut _GetShaderPrecisionFormat: extern "system" fn(GLenum, GLenum, *mut GLint, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetShaderSource: extern "system" fn(GLuint, GLsizei, *mut GLsizei, *mut GLchar) =
    unsafe { transmute(ERR) };
...
static mut _GetStringi: extern "system" fn(GLenum, GLuint) -> *const GLubyte =
    unsafe { transmute(ERR) };
static mut _GetSubroutineIndex: extern "system" fn(GLuint, GLenum, *const GLchar) -> GLuint =
    unsafe { transmute(ERR) };
static mut _GetSubroutineUniformLocation: extern "system" fn(
    GLuint,
    GLenum,
    *const GLchar,
) -> GLint = unsafe { transmute(ERR) };
static mut _GetSynciv: extern "system" fn(GLsync, GLenum, GLsizei, *mut GLsizei, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetTexImage: extern "system" fn(GLenum, GLint, GLenum, GLenum, *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetTexLevelParameterfv: extern "system" fn(GLenum, GLint, GLenum, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetTexLevelParameteriv: extern "system" fn(GLenum, GLint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetTexParameterIiv: extern "system" fn(GLenum, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetTexParameterIuiv: extern "system" fn(GLenum, GLenum, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetTexParameterfv: extern "system" fn(GLenum, GLenum, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetTexParameteriv: extern "system" fn(GLenum, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetTextureImage: extern "system" fn(
    GLuint,
    GLint,
    GLenum,
    GLenum,
...
static mut _GetTextureLevelParameterfv: extern "system" fn(GLuint, GLint, GLenum, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetTextureLevelParameteriv: extern "system" fn(GLuint, GLint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetTextureParameterIiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetTextureParameterIuiv: extern "system" fn(GLuint, GLenum, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetTextureParameterfv: extern "system" fn(GLuint, GLenum, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetTextureParameteriv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetTextureSubImage: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _GetTransformFeedbackVarying: extern "system" fn(
    GLuint,
    GLuint,
    GLsizei,
    *mut GLsizei,
...
static mut _GetTransformFeedbacki64_v: extern "system" fn(GLuint, GLenum, GLuint, *mut GLint64) =
    unsafe { transmute(ERR) };
static mut _GetTransformFeedbacki_v: extern "system" fn(GLuint, GLenum, GLuint, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetTransformFeedbackiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetUniformBlockIndex: extern "system" fn(GLuint, *const GLchar) -> GLuint =
    unsafe { transmute(ERR) };
static mut _GetUniformIndices: extern "system" fn(
    GLuint,
    GLsizei,
    *const *const GLchar,
    *mut GLuint,
) = unsafe { transmute(ERR) };
static mut _GetUniformLocation: extern "system" fn(GLuint, *const GLchar) -> GLint =
    unsafe { transmute(ERR) };
static mut _GetUniformSubroutineuiv: extern "system" fn(GLenum, GLint, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetUniformdv: extern "system" fn(GLuint, GLint, *mut GLdouble) =
    unsafe { transmute(ERR) };
static mut _GetUniformfv: extern "system" fn(GLuint, GLint, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetUniformiv: extern "system" fn(GLuint, GLint, *mut GLint) = unsafe { transmute(ERR) };
static mut _GetUniformuiv: extern "system" fn(GLuint, GLint, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetVertexArrayIndexed64iv: extern "system" fn(GLuint, GLuint, GLenum, *mut GLint64) =
    unsafe { transmute(ERR) };
static mut _GetVertexArrayIndexediv: extern "system" fn(GLuint, GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetVertexArrayiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetVertexAttribIiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetVertexAttribIuiv: extern "system" fn(GLuint, GLenum, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetVertexAttribLdv: extern "system" fn(GLuint, GLenum, *mut GLdouble) =
    unsafe { transmute(ERR) };
static mut _GetVertexAttribPointerv: extern "system" fn(GLuint, GLenum, *const *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetVertexAttribdv: extern "system" fn(GLuint, GLenum, *mut GLdouble) =
    unsafe { transmute(ERR) };
static mut _GetVertexAttribfv: extern "system" fn(GLuint, GLenum, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetVertexAttribiv: extern "system" fn(GLuint, GLenum, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetnColorTable: extern "system" fn(GLenum, GLenum, GLenum, GLsizei, *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetnCompressedTexImage: extern "system" fn(GLenum, GLint, GLsizei, *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetnConvolutionFilter: extern "system" fn(
    GLenum,
    GLenum,
    GLenum,
    GLsizei,
...
static mut _GetnHistogram: extern "system" fn(
    GLenum,
    GLboolean,
    GLenum,
    GLenum,
...
static mut _GetnMapdv: extern "system" fn(GLenum, GLenum, GLsizei, *mut GLdouble) =
    unsafe { transmute(ERR) };
static mut _GetnMapfv: extern "system" fn(GLenum, GLenum, GLsizei, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetnMapiv: extern "system" fn(GLenum, GLenum, GLsizei, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetnMinmax: extern "system" fn(
    GLenum,
    GLboolean,
    GLenum,
    GLenum,
...
static mut _GetnPixelMapfv: extern "system" fn(GLenum, GLsizei, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetnPixelMapuiv: extern "system" fn(GLenum, GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
static mut _GetnPixelMapusv: extern "system" fn(GLenum, GLsizei, *mut GLushort) =
    unsafe { transmute(ERR) };
static mut _GetnPolygonStipple: extern "system" fn(GLsizei, *mut GLubyte) =
    unsafe { transmute(ERR) };
static mut _GetnSeparableFilter: extern "system" fn(
    GLenum,
    GLenum,
    GLenum,
    GLsizei,
...
static mut _GetnTexImage: extern "system" fn(GLenum, GLint, GLenum, GLenum, GLsizei, *mut c_void) =
    unsafe { transmute(ERR) };
static mut _GetnUniformdv: extern "system" fn(GLuint, GLint, GLsizei, *mut GLdouble) =
    unsafe { transmute(ERR) };
static mut _GetnUniformfv: extern "system" fn(GLuint, GLint, GLsizei, *mut GLfloat) =
    unsafe { transmute(ERR) };
static mut _GetnUniformiv: extern "system" fn(GLuint, GLint, GLsizei, *mut GLint) =
    unsafe { transmute(ERR) };
static mut _GetnUniformuiv: extern "system" fn(GLuint, GLint, GLsizei, *mut GLuint) =
    unsafe { transmute(ERR) };
...
static mut _InvalidateBufferSubData: extern "system" fn(GLuint, GLintptr, GLsizeiptr) =
    unsafe { transmute(ERR) };
static mut _InvalidateFramebuffer: extern "system" fn(GLenum, GLsizei, *const GLenum) =
    unsafe { transmute(ERR) };
static mut _InvalidateNamedFramebufferData: extern "system" fn(GLuint, GLsizei, *const GLenum) =
    unsafe { transmute(ERR) };
static mut _InvalidateNamedFramebufferSubData: extern "system" fn(
    GLuint,
    GLsizei,
    *const GLenum,
    GLint,
...
static mut _InvalidateSubFramebuffer: extern "system" fn(
    GLenum,
    GLsizei,
    *const GLenum,
    GLint,
...
static mut _InvalidateTexSubImage: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _IsTransformFeedback: extern "system" fn(GLuint) -> GLboolean =
    unsafe { transmute(ERR) };
...
static mut _MapBuffer: extern "system" fn(GLenum, GLenum) -> *mut c_void =
    unsafe { transmute(ERR) };
static mut _MapBufferRange: extern "system" fn(
    GLenum,
    GLintptr,
    GLsizeiptr,
    GLbitfield,
) -> *mut c_void = unsafe { transmute(ERR) };
static mut _MapNamedBuffer: extern "system" fn(GLuint, GLenum) -> *mut c_void =
    unsafe { transmute(ERR) };
static mut _MapNamedBufferRange: extern "system" fn(
    GLuint,
    GLintptr,
    GLsizeiptr,
    GLbitfield,
...
static mut _MultiDrawArrays: extern "system" fn(GLenum, *const GLint, *const GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _MultiDrawArraysIndirect: extern "system" fn(GLenum, *const c_void, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _MultiDrawArraysIndirectCount: extern "system" fn(
    GLenum,
    *const c_void,
    GLintptr,
    GLsizei,
...
static mut _MultiDrawElements: extern "system" fn(
    GLenum,
    *const GLsizei,
    GLenum,
    *const *const c_void,
...
static mut _MultiDrawElementsBaseVertex: extern "system" fn(
    GLenum,
    *const GLsizei,
    GLenum,
    *const *const c_void,
...
static mut _MultiDrawElementsIndirect: extern "system" fn(
    GLenum,
    GLenum,
    *const c_void,
    GLsizei,
...
static mut _MultiDrawElementsIndirectCount: extern "system" fn(
    GLenum,
    GLenum,
    *const c_void,
    GLintptr,
...
static mut _MultiTexCoordP1ui: extern "system" fn(GLenum, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _MultiTexCoordP1uiv: extern "system" fn(GLenum, GLenum, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _MultiTexCoordP2ui: extern "system" fn(GLenum, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _MultiTexCoordP2uiv: extern "system" fn(GLenum, GLenum, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _MultiTexCoordP3ui: extern "system" fn(GLenum, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _MultiTexCoordP3uiv: extern "system" fn(GLenum, GLenum, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _MultiTexCoordP4ui: extern "system" fn(GLenum, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _MultiTexCoordP4uiv: extern "system" fn(GLenum, GLenum, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _NamedBufferData: extern "system" fn(GLuint, GLsizeiptr, *const c_void, GLenum) =
    unsafe { transmute(ERR) };
static mut _NamedBufferStorage: extern "system" fn(GLuint, GLsizeiptr, *const c_void, GLbitfield) =
    unsafe { transmute(ERR) };
static mut _NamedBufferSubData: extern "system" fn(GLuint, GLintptr, GLsizeiptr, *const c_void) =
    unsafe { transmute(ERR) };
static mut _NamedFramebufferDrawBuffer: extern "system" fn(GLuint, GLenum) =
    unsafe { transmute(ERR) };
static mut _NamedFramebufferDrawBuffers: extern "system" fn(GLuint, GLsizei, *const GLenum) =
    unsafe { transmute(ERR) };
static mut _NamedFramebufferParameteri: extern "system" fn(GLuint, GLenum, GLint) =
    unsafe { transmute(ERR) };
static mut _NamedFramebufferReadBuffer: extern "system" fn(GLuint, GLenum) =
    unsafe { transmute(ERR) };
static mut _NamedFramebufferRenderbuffer: extern "system" fn(GLuint, GLenum, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _NamedFramebufferTexture: extern "system" fn(GLuint, GLenum, GLuint, GLint) =
    unsafe { transmute(ERR) };
static mut _NamedFramebufferTextureLayer: extern "system" fn(GLuint, GLenum, GLuint, GLint, GLint) =
    unsafe { transmute(ERR) };
static mut _NamedRenderbufferStorage: extern "system" fn(GLuint, GLenum, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _NamedRenderbufferStorageMultisample: extern "system" fn(
    GLuint,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _ObjectLabel: extern "system" fn(GLenum, GLuint, GLsizei, *const GLchar) =
    unsafe { transmute(ERR) };
static mut _ObjectPtrLabel: extern "system" fn(*const c_void, GLsizei, *const GLchar) =
    unsafe { transmute(ERR) };
static mut _PatchParameterfv: extern "system" fn(GLenum, *const GLfloat) =
    unsafe { transmute(ERR) };
...
static mut _PointParameterfv: extern "system" fn(GLenum, *const GLfloat) =
    unsafe { transmute(ERR) };
...
static mut _PolygonOffsetClamp: extern "system" fn(GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
...
static mut _ProgramBinary: extern "system" fn(GLuint, GLenum, *const c_void, GLsizei) =
    unsafe { transmute(ERR) };
static mut _ProgramParameteri: extern "system" fn(GLuint, GLenum, GLint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform1d: extern "system" fn(GLuint, GLint, GLdouble) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform1dv: extern "system" fn(GLuint, GLint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform1f: extern "system" fn(GLuint, GLint, GLfloat) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform1fv: extern "system" fn(GLuint, GLint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform1i: extern "system" fn(GLuint, GLint, GLint) = unsafe { transmute(ERR) };
static mut _ProgramUniform1iv: extern "system" fn(GLuint, GLint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform1ui: extern "system" fn(GLuint, GLint, GLuint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform1uiv: extern "system" fn(GLuint, GLint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform2d: extern "system" fn(GLuint, GLint, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform2dv: extern "system" fn(GLuint, GLint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform2f: extern "system" fn(GLuint, GLint, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform2fv: extern "system" fn(GLuint, GLint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform2i: extern "system" fn(GLuint, GLint, GLint, GLint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform2iv: extern "system" fn(GLuint, GLint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform2ui: extern "system" fn(GLuint, GLint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform2uiv: extern "system" fn(GLuint, GLint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform3d: extern "system" fn(GLuint, GLint, GLdouble, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform3dv: extern "system" fn(GLuint, GLint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform3f: extern "system" fn(GLuint, GLint, GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform3fv: extern "system" fn(GLuint, GLint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform3i: extern "system" fn(GLuint, GLint, GLint, GLint, GLint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform3iv: extern "system" fn(GLuint, GLint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform3ui: extern "system" fn(GLuint, GLint, GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform3uiv: extern "system" fn(GLuint, GLint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform4d: extern "system" fn(
    GLuint,
    GLint,
    GLdouble,
    GLdouble,
...
static mut _ProgramUniform4dv: extern "system" fn(GLuint, GLint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform4f: extern "system" fn(
    GLuint,
    GLint,
    GLfloat,
    GLfloat,
...
static mut _ProgramUniform4fv: extern "system" fn(GLuint, GLint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform4i: extern "system" fn(GLuint, GLint, GLint, GLint, GLint, GLint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform4iv: extern "system" fn(GLuint, GLint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform4ui: extern "system" fn(GLuint, GLint, GLuint, GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniform4uiv: extern "system" fn(GLuint, GLint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _ProgramUniformMatrix2dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix2fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix2x3dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix2x3fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix2x4dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix2x4fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix3dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix3fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix3x2dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix3x2fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix3x4dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix3x4fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix4dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix4fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix4x2dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix4x2fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix4x3dv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _ProgramUniformMatrix4x3fv: extern "system" fn(
    GLuint,
    GLint,
    GLsizei,
    GLboolean,
...
static mut _PushDebugGroup: extern "system" fn(GLenum, GLuint, GLsizei, *const GLchar) =
    unsafe { transmute(ERR) };
...
static mut _ReadPixels: extern "system" fn(
    GLint,
    GLint,
    GLsizei,
    GLsizei,
...
static mut _ReadnPixels: extern "system" fn(
    GLint,
    GLint,
    GLsizei,
    GLsizei,
...
static mut _RenderbufferStorage: extern "system" fn(GLenum, GLenum, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _RenderbufferStorageMultisample: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _SamplerParameterIiv: extern "system" fn(GLuint, GLenum, *const GLint) =
    unsafe { transmute(ERR) };
static mut _SamplerParameterIuiv: extern "system" fn(GLuint, GLenum, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _SamplerParameterf: extern "system" fn(GLuint, GLenum, GLfloat) =
    unsafe { transmute(ERR) };
static mut _SamplerParameterfv: extern "system" fn(GLuint, GLenum, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _SamplerParameteri: extern "system" fn(GLuint, GLenum, GLint) =
    unsafe { transmute(ERR) };
static mut _SamplerParameteriv: extern "system" fn(GLuint, GLenum, *const GLint) =
    unsafe { transmute(ERR) };
static mut _Scissor: extern "system" fn(GLint, GLint, GLsizei, GLsizei) = unsafe { transmute(ERR) };
static mut _ScissorArrayv: extern "system" fn(GLuint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _ScissorIndexed: extern "system" fn(GLuint, GLint, GLint, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
...
static mut _SecondaryColorP3uiv: extern "system" fn(GLenum, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _ShaderBinary: extern "system" fn(
    GLsizei,
    *const GLuint,
    GLenum,
    *const c_void,
...
static mut _ShaderSource: extern "system" fn(GLuint, GLsizei, *const *const GLchar, *const GLint) =
    unsafe { transmute(ERR) };
static mut _ShaderStorageBlockBinding: extern "system" fn(GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _SpecializeShader: extern "system" fn(
    GLuint,
    *const GLchar,
    GLuint,
    *const GLuint,
...
static mut _StencilFuncSeparate: extern "system" fn(GLenum, GLenum, GLint, GLuint) =
    unsafe { transmute(ERR) };
...
static mut _StencilOpSeparate: extern "system" fn(GLenum, GLenum, GLenum, GLenum) =
    unsafe { transmute(ERR) };
static mut _TexBuffer: extern "system" fn(GLenum, GLenum, GLuint) = unsafe { transmute(ERR) };
static mut _TexBufferRange: extern "system" fn(GLenum, GLenum, GLuint, GLintptr, GLsizeiptr) =
    unsafe { transmute(ERR) };
...
static mut _TexImage1D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLsizei,
...
static mut _TexImage2D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLsizei,
...
static mut _TexImage2DMultisample: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _TexImage3D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLsizei,
...
static mut _TexImage3DMultisample: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _TexParameterIiv: extern "system" fn(GLenum, GLenum, *const GLint) =
    unsafe { transmute(ERR) };
static mut _TexParameterIuiv: extern "system" fn(GLenum, GLenum, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _TexParameterf: extern "system" fn(GLenum, GLenum, GLfloat) = unsafe { transmute(ERR) };
static mut _TexParameterfv: extern "system" fn(GLenum, GLenum, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _TexParameteri: extern "system" fn(GLenum, GLenum, GLint) = unsafe { transmute(ERR) };
static mut _TexParameteriv: extern "system" fn(GLenum, GLenum, *const GLint) =
    unsafe { transmute(ERR) };
static mut _TexStorage1D: extern "system" fn(GLenum, GLsizei, GLenum, GLsizei) =
    unsafe { transmute(ERR) };
static mut _TexStorage2D: extern "system" fn(GLenum, GLsizei, GLenum, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _TexStorage2DMultisample: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _TexStorage3D: extern "system" fn(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _TexStorage3DMultisample: extern "system" fn(
    GLenum,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _TexSubImage1D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLsizei,
...
static mut _TexSubImage2D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLint,
...
static mut _TexSubImage3D: extern "system" fn(
    GLenum,
    GLint,
    GLint,
    GLint,
...
static mut _TextureBufferRange: extern "system" fn(GLuint, GLenum, GLuint, GLintptr, GLsizeiptr) =
    unsafe { transmute(ERR) };
static mut _TextureParameterIiv: extern "system" fn(GLuint, GLenum, *const GLint) =
    unsafe { transmute(ERR) };
static mut _TextureParameterIuiv: extern "system" fn(GLuint, GLenum, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _TextureParameterf: extern "system" fn(GLuint, GLenum, GLfloat) =
    unsafe { transmute(ERR) };
static mut _TextureParameterfv: extern "system" fn(GLuint, GLenum, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _TextureParameteri: extern "system" fn(GLuint, GLenum, GLint) =
    unsafe { transmute(ERR) };
static mut _TextureParameteriv: extern "system" fn(GLuint, GLenum, *const GLint) =
    unsafe { transmute(ERR) };
static mut _TextureStorage1D: extern "system" fn(GLuint, GLsizei, GLenum, GLsizei) =
    unsafe { transmute(ERR) };
static mut _TextureStorage2D: extern "system" fn(GLuint, GLsizei, GLenum, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _TextureStorage2DMultisample: extern "system" fn(
    GLuint,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _TextureStorage3D: extern "system" fn(
    GLuint,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _TextureStorage3DMultisample: extern "system" fn(
    GLuint,
    GLsizei,
    GLenum,
    GLsizei,
...
static mut _TextureSubImage1D: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLsizei,
...
static mut _TextureSubImage2D: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _TextureSubImage3D: extern "system" fn(
    GLuint,
    GLint,
    GLint,
    GLint,
...
static mut _TextureView: extern "system" fn(
    GLuint,
    GLenum,
    GLuint,
    GLenum,
...
static mut _TransformFeedbackBufferBase: extern "system" fn(GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _TransformFeedbackBufferRange: extern "system" fn(
    GLuint,
    GLuint,
    GLuint,
    GLintptr,
...
static mut _TransformFeedbackVaryings: extern "system" fn(
    GLuint,
    GLsizei,
    *const *const GLchar,
    GLenum,
...
static mut _Uniform1dv: extern "system" fn(GLint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _Uniform1f: extern "system" fn(GLint, GLfloat) = unsafe { transmute(ERR) };
static mut _Uniform1fv: extern "system" fn(GLint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _Uniform1i: extern "system" fn(GLint, GLint) = unsafe { transmute(ERR) };
static mut _Uniform1iv: extern "system" fn(GLint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _Uniform1ui: extern "system" fn(GLint, GLuint) = unsafe { transmute(ERR) };
static mut _Uniform1uiv: extern "system" fn(GLint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _Uniform2d: extern "system" fn(GLint, GLdouble, GLdouble) = unsafe { transmute(ERR) };
static mut _Uniform2dv: extern "system" fn(GLint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _Uniform2f: extern "system" fn(GLint, GLfloat, GLfloat) = unsafe { transmute(ERR) };
static mut _Uniform2fv: extern "system" fn(GLint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _Uniform2i: extern "system" fn(GLint, GLint, GLint) = unsafe { transmute(ERR) };
static mut _Uniform2iv: extern "system" fn(GLint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _Uniform2ui: extern "system" fn(GLint, GLuint, GLuint) = unsafe { transmute(ERR) };
static mut _Uniform2uiv: extern "system" fn(GLint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _Uniform3d: extern "system" fn(GLint, GLdouble, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _Uniform3dv: extern "system" fn(GLint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _Uniform3f: extern "system" fn(GLint, GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
static mut _Uniform3fv: extern "system" fn(GLint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _Uniform3i: extern "system" fn(GLint, GLint, GLint, GLint) = unsafe { transmute(ERR) };
static mut _Uniform3iv: extern "system" fn(GLint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _Uniform3ui: extern "system" fn(GLint, GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _Uniform3uiv: extern "system" fn(GLint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _Uniform4d: extern "system" fn(GLint, GLdouble, GLdouble, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _Uniform4dv: extern "system" fn(GLint, GLsizei, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _Uniform4f: extern "system" fn(GLint, GLfloat, GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
static mut _Uniform4fv: extern "system" fn(GLint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _Uniform4i: extern "system" fn(GLint, GLint, GLint, GLint, GLint) =
    unsafe { transmute(ERR) };
static mut _Uniform4iv: extern "system" fn(GLint, GLsizei, *const GLint) =
    unsafe { transmute(ERR) };
static mut _Uniform4ui: extern "system" fn(GLint, GLuint, GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _Uniform4uiv: extern "system" fn(GLint, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _UniformBlockBinding: extern "system" fn(GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix2dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix2fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix2x3dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix2x3fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix2x4dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix2x4fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix3dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix3fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix3x2dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix3x2fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix3x4dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix3x4fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix4dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix4fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix4x2dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix4x2fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix4x3dv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _UniformMatrix4x3fv: extern "system" fn(GLint, GLsizei, GLboolean, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _UniformSubroutinesuiv: extern "system" fn(GLenum, GLsizei, *const GLuint) =
    unsafe { transmute(ERR) };
...
static mut _UseProgramStages: extern "system" fn(GLuint, GLbitfield, GLuint) =
    unsafe { transmute(ERR) };
...
static mut _VertexArrayAttribBinding: extern "system" fn(GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexArrayAttribFormat: extern "system" fn(
    GLuint,
    GLuint,
    GLint,
    GLenum,
...
static mut _VertexArrayAttribIFormat: extern "system" fn(GLuint, GLuint, GLint, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexArrayAttribLFormat: extern "system" fn(GLuint, GLuint, GLint, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexArrayBindingDivisor: extern "system" fn(GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexArrayElementBuffer: extern "system" fn(GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexArrayVertexBuffer: extern "system" fn(GLuint, GLuint, GLuint, GLintptr, GLsizei) =
    unsafe { transmute(ERR) };
static mut _VertexArrayVertexBuffers: extern "system" fn(
    GLuint,
    GLuint,
    GLsizei,
    *const GLuint,
...
static mut _VertexAttrib1dv: extern "system" fn(GLuint, *const GLdouble) =
    unsafe { transmute(ERR) };
...
static mut _VertexAttrib2d: extern "system" fn(GLuint, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib2dv: extern "system" fn(GLuint, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib2f: extern "system" fn(GLuint, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib2fv: extern "system" fn(GLuint, *const GLfloat) = unsafe { transmute(ERR) };
static mut _VertexAttrib2s: extern "system" fn(GLuint, GLshort, GLshort) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib2sv: extern "system" fn(GLuint, *const GLshort) = unsafe { transmute(ERR) };
static mut _VertexAttrib3d: extern "system" fn(GLuint, GLdouble, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib3dv: extern "system" fn(GLuint, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib3f: extern "system" fn(GLuint, GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib3fv: extern "system" fn(GLuint, *const GLfloat) = unsafe { transmute(ERR) };
static mut _VertexAttrib3s: extern "system" fn(GLuint, GLshort, GLshort, GLshort) =
    unsafe { transmute(ERR) };
...
static mut _VertexAttrib4Nsv: extern "system" fn(GLuint, *const GLshort) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4Nub: extern "system" fn(GLuint, GLubyte, GLubyte, GLubyte, GLubyte) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4Nubv: extern "system" fn(GLuint, *const GLubyte) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4Nuiv: extern "system" fn(GLuint, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4Nusv: extern "system" fn(GLuint, *const GLushort) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4bv: extern "system" fn(GLuint, *const GLbyte) = unsafe { transmute(ERR) };
static mut _VertexAttrib4d: extern "system" fn(GLuint, GLdouble, GLdouble, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4dv: extern "system" fn(GLuint, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4f: extern "system" fn(GLuint, GLfloat, GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
...
static mut _VertexAttrib4s: extern "system" fn(GLuint, GLshort, GLshort, GLshort, GLshort) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4sv: extern "system" fn(GLuint, *const GLshort) = unsafe { transmute(ERR) };
static mut _VertexAttrib4ubv: extern "system" fn(GLuint, *const GLubyte) =
    unsafe { transmute(ERR) };
static mut _VertexAttrib4uiv: extern "system" fn(GLuint, *const GLuint) = unsafe { transmute(ERR) };
static mut _VertexAttrib4usv: extern "system" fn(GLuint, *const GLushort) =
    unsafe { transmute(ERR) };
...
static mut _VertexAttribFormat: extern "system" fn(GLuint, GLint, GLenum, GLboolean, GLuint) =
    unsafe { transmute(ERR) };
...
static mut _VertexAttribI1uiv: extern "system" fn(GLuint, *const GLuint) =
    unsafe { transmute(ERR) };
...
static mut _VertexAttribI2ui: extern "system" fn(GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI2uiv: extern "system" fn(GLuint, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI3i: extern "system" fn(GLuint, GLint, GLint, GLint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI3iv: extern "system" fn(GLuint, *const GLint) = unsafe { transmute(ERR) };
static mut _VertexAttribI3ui: extern "system" fn(GLuint, GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI3uiv: extern "system" fn(GLuint, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI4bv: extern "system" fn(GLuint, *const GLbyte) = unsafe { transmute(ERR) };
static mut _VertexAttribI4i: extern "system" fn(GLuint, GLint, GLint, GLint, GLint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI4iv: extern "system" fn(GLuint, *const GLint) = unsafe { transmute(ERR) };
static mut _VertexAttribI4sv: extern "system" fn(GLuint, *const GLshort) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI4ubv: extern "system" fn(GLuint, *const GLubyte) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI4ui: extern "system" fn(GLuint, GLuint, GLuint, GLuint, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI4uiv: extern "system" fn(GLuint, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribI4usv: extern "system" fn(GLuint, *const GLushort) =
    unsafe { transmute(ERR) };
static mut _VertexAttribIFormat: extern "system" fn(GLuint, GLint, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribIPointer: extern "system" fn(
    GLuint,
    GLint,
    GLenum,
    GLsizei,
...
static mut _VertexAttribL1dv: extern "system" fn(GLuint, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttribL2d: extern "system" fn(GLuint, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttribL2dv: extern "system" fn(GLuint, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttribL3d: extern "system" fn(GLuint, GLdouble, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttribL3dv: extern "system" fn(GLuint, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttribL4d: extern "system" fn(GLuint, GLdouble, GLdouble, GLdouble, GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttribL4dv: extern "system" fn(GLuint, *const GLdouble) =
    unsafe { transmute(ERR) };
static mut _VertexAttribLFormat: extern "system" fn(GLuint, GLint, GLenum, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribLPointer: extern "system" fn(
    GLuint,
    GLint,
    GLenum,
    GLsizei,
...
static mut _VertexAttribP1ui: extern "system" fn(GLuint, GLenum, GLboolean, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribP1uiv: extern "system" fn(GLuint, GLenum, GLboolean, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribP2ui: extern "system" fn(GLuint, GLenum, GLboolean, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribP2uiv: extern "system" fn(GLuint, GLenum, GLboolean, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribP3ui: extern "system" fn(GLuint, GLenum, GLboolean, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribP3uiv: extern "system" fn(GLuint, GLenum, GLboolean, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribP4ui: extern "system" fn(GLuint, GLenum, GLboolean, GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribP4uiv: extern "system" fn(GLuint, GLenum, GLboolean, *const GLuint) =
    unsafe { transmute(ERR) };
static mut _VertexAttribPointer: extern "system" fn(
    GLuint,
    GLint,
    GLenum,
    GLboolean,
...
static mut _Viewport: extern "system" fn(GLint, GLint, GLsizei, GLsizei) =
    unsafe { transmute(ERR) };
static mut _ViewportArrayv: extern "system" fn(GLuint, GLsizei, *const GLfloat) =
    unsafe { transmute(ERR) };
static mut _ViewportIndexedf: extern "system" fn(GLuint, GLfloat, GLfloat, GLfloat, GLfloat) =
    unsafe { transmute(ERR) };
static mut _ViewportIndexedfv: extern "system" fn(GLuint, *const GLfloat) =
    unsafe { transmute(ERR) };
...
pub unsafe fn load_gl<F: FnMut(&'static str) -> *const c_void>(func: &mut F) {
    _ActiveShaderProgram = transmute(load(func, "ActiveShaderProgram", &[]));
    ...
    _BeginConditionalRender = transmute(load(
        func,
    ...
    _BeginTransformFeedback = transmute(load(
        func,
        "BeginTransformFeedback",
        &["BeginTransformFeedbackEXT", "BeginTransformFeedbackNV"],
    ));
    ...
    _BindBufferBase = transmute(load(
        func,
        "BindBufferBase",
        &["BindBufferBaseEXT", "BindBufferBaseNV"],
    ));
    _BindBufferRange = transmute(load(
        func,
        "BindBufferRange",
        &["BindBufferRangeEXT", "BindBufferRangeNV"],
    ));
    _BindBuffersBase = transmute(load(func, "BindBuffersBase", &[]));
    _BindBuffersRange = transmute(load(func, "BindBuffersRange", &[]));
    _BindFragDataLocation = transmute(load(
        func,
        "BindFragDataLocation",
        &["BindFragDataLocationEXT"],
    ));
    _BindFragDataLocationIndexed = transmute(load(
        func,
    ...
    _BlendEquationSeparate = transmute(load(
        func,
        "BlendEquationSeparate",
        &["BlendEquationSeparateEXT"],
    ));
    _BlendEquationSeparatei = transmute(load(
        func,
    ...
    _BlendEquationi = transmute(load(
        func,
        "BlendEquationi",
        &[
    ...
    _BlendFuncSeparate = transmute(load(
        func,
        "BlendFuncSeparate",
        &["BlendFuncSeparateEXT", "BlendFuncSeparateINGR"],
    ));
    _BlendFuncSeparatei = transmute(load(
        func,
        "BlendFuncSeparatei",
        &[
    ...
    _BlitFramebuffer = transmute(load(
        func,
        "BlitFramebuffer",
        &["BlitFramebufferEXT", "BlitFramebufferNV"],
    ));
    ...
    _CheckFramebufferStatus = transmute(load(
        func,
    ...
    _ColorMaski = transmute(load(
        func,
        "ColorMaski",
        &["ColorMaskIndexedEXT", "ColorMaskiEXT", "ColorMaskiOES"],
    ));
    ...
    _CompressedTexImage1D = transmute(load(
        func,
        "CompressedTexImage1D",
        &["CompressedTexImage1DARB"],
    ));
    _CompressedTexImage2D = transmute(load(
        func,
        "CompressedTexImage2D",
        &["CompressedTexImage2DARB"],
    ));
    _CompressedTexImage3D = transmute(load(
        func,
        "CompressedTexImage3D",
        &["CompressedTexImage3DARB"],
    ));
    _CompressedTexSubImage1D = transmute(load(
        func,
        "CompressedTexSubImage1D",
        &["CompressedTexSubImage1DARB"],
    ));
    _CompressedTexSubImage2D = transmute(load(
        func,
        "CompressedTexSubImage2D",
        &["CompressedTexSubImage2DARB"],
    ));
    _CompressedTexSubImage3D = transmute(load(
        func,
    ...
    _CopyImageSubData = transmute(load(
        func,
        "CopyImageSubData",
        &["CopyImageSubDataEXT", "CopyImageSubDataOES"],
    ));
    ...
    _DebugMessageCallback = transmute(load(
        func,
        "DebugMessageCallback",
        &["DebugMessageCallbackARB", "DebugMessageCallbackKHR"],
    ));
    _DebugMessageControl = transmute(load(
        func,
        "DebugMessageControl",
        &["DebugMessageControlARB", "DebugMessageControlKHR"],
    ));
    _DebugMessageInsert = transmute(load(
        func,
        "DebugMessageInsert",
        &["DebugMessageInsertARB", "DebugMessageInsertKHR"],
    ));
    ...
    _DeleteRenderbuffers = transmute(load(
        func,
        "DeleteRenderbuffers",
    ...
    _DeleteTransformFeedbacks = transmute(load(
        func,
        "DeleteTransformFeedbacks",
        &["DeleteTransformFeedbacksNV"],
    ));
    _DeleteVertexArrays = transmute(load(
        func,
        "DeleteVertexArrays",
        &["DeleteVertexArraysAPPLE", "DeleteVertexArraysOES"],
    ));
    ...
    _DisableVertexAttribArray = transmute(load(
        func,
        "DisableVertexAttribArray",
        &["DisableVertexAttribArrayARB"],
    ));
    _Disablei = transmute(load(
        func,
        "Disablei",
        &[
            "DisableIndexedEXT",
    ...
    _DrawArraysInstanced = transmute(load(
        func,
        "DrawArraysInstanced",
        &[
    ...
    _DrawElementsInstancedBaseInstance = transmute(load(
        func,
        "DrawElementsInstancedBaseInstance",
        &["DrawElementsInstancedBaseInstanceEXT"],
    ));
    _DrawElementsInstancedBaseVertex = transmute(load(
        func,
    ...
    _DrawElementsInstancedBaseVertexBaseInstance = transmute(load(
        func,
    ...
    _DrawRangeElementsBaseVertex = transmute(load(
        func,
    ...
    _DrawTransformFeedback = transmute(load(
        func,
        "DrawTransformFeedback",
        &["DrawTransformFeedbackEXT", "DrawTransformFeedbackNV"],
    ));
    _DrawTransformFeedbackInstanced = transmute(load(
        func,
        "DrawTransformFeedbackInstanced",
        &["DrawTransformFeedbackInstancedEXT"],
    ));
    _DrawTransformFeedbackStream = transmute(load(func, "DrawTransformFeedbackStream", &[]));
    _DrawTransformFeedbackStreamInstanced =
        transmute(load(func, "DrawTransformFeedbackStreamInstanced", &[]));
    _Enable = transmute(load(func, "Enable", &[]));
    _EnableVertexArrayAttrib = transmute(load(func, "EnableVertexArrayAttrib", &[]));
    _EnableVertexAttribArray = transmute(load(
        func,
        "EnableVertexAttribArray",
        &["EnableVertexAttribArrayARB"],
    ));
    _Enablei = transmute(load(
        func,
        "Enablei",
        &["EnableIndexedEXT", "EnableiEXT", "EnableiNV", "EnableiOES"],
    ));
    _EndConditionalRender = transmute(load(
        func,
        "EndConditionalRender",
        &["EndConditionalRenderNV", "EndConditionalRenderNVX"],
    ));
    _EndQuery = transmute(load(func, "EndQuery", &["EndQueryARB"]));
    _EndQueryIndexed = transmute(load(func, "EndQueryIndexed", &[]));
    _EndTransformFeedback = transmute(load(
        func,
    ...
    _FlushMappedBufferRange = transmute(load(
        func,
        "FlushMappedBufferRange",
        &["FlushMappedBufferRangeAPPLE", "FlushMappedBufferRangeEXT"],
    ));
    ...
    _FramebufferRenderbuffer = transmute(load(
        func,
        "FramebufferRenderbuffer",
        &["FramebufferRenderbufferEXT"],
    ));
    _FramebufferTexture = transmute(load(
        func,
        "FramebufferTexture",
        &[
    ...
    _FramebufferTexture1D = transmute(load(
        func,
        "FramebufferTexture1D",
        &["FramebufferTexture1DEXT"],
    ));
    _FramebufferTexture2D = transmute(load(
        func,
        "FramebufferTexture2D",
        &["FramebufferTexture2DEXT"],
    ));
    _FramebufferTexture3D = transmute(load(
        func,
        "FramebufferTexture3D",
        &["FramebufferTexture3DEXT"],
    ));
    _FramebufferTextureLayer = transmute(load(
        func,
        "FramebufferTextureLayer",
        &["FramebufferTextureLayerARB", "FramebufferTextureLayerEXT"],
    ));
    ...
    _GenTransformFeedbacks = transmute(load(
        func,
        "GenTransformFeedbacks",
        &["GenTransformFeedbacksNV"],
    ));
    _GenVertexArrays = transmute(load(
        func,
        "GenVertexArrays",
        &["GenVertexArraysAPPLE", "GenVertexArraysOES"],
    ));
    ...
    _GetBufferParameteriv = transmute(load(
        func,
        "GetBufferParameteriv",
        &["GetBufferParameterivARB"],
    ));
    _GetBufferPointerv = transmute(load(
        func,
        "GetBufferPointerv",
        &["GetBufferPointervARB", "GetBufferPointervOES"],
    ));
    _GetBufferSubData = transmute(load(func, "GetBufferSubData", &["GetBufferSubDataARB"]));
    _GetCompressedTexImage = transmute(load(
        func,
    ...
    _GetDebugMessageLog = transmute(load(
        func,
        "GetDebugMessageLog",
        &["GetDebugMessageLogARB", "GetDebugMessageLogKHR"],
    ));
    _GetDoublei_v = transmute(load(
        func,
        "GetDoublei_v",
        &["GetDoubleIndexedvEXT", "GetDoublei_vEXT"],
    ));
    _GetDoublev = transmute(load(func, "GetDoublev", &[]));
    _GetError = transmute(load(func, "GetError", &[]));
    _GetFloati_v = transmute(load(
        func,
        "GetFloati_v",
        &[
            "GetFloatIndexedvEXT",
    ...
    _GetFragDataLocation = transmute(load(
        func,
        "GetFragDataLocation",
        &["GetFragDataLocationEXT"],
    ));
    _GetFramebufferAttachmentParameteriv = transmute(load(
        func,
        "GetFramebufferAttachmentParameteriv",
        &["GetFramebufferAttachmentParameterivEXT"],
    ));
    _GetFramebufferParameteriv = transmute(load(func, "GetFramebufferParameteriv", &[]));
    _GetGraphicsResetStatus = transmute(load(
        func,
        "GetGraphicsResetStatus",
        &["GetGraphicsResetStatusEXT", "GetGraphicsResetStatusKHR"],
    ));
    ...
    _GetNamedFramebufferAttachmentParameteriv =
        transmute(load(func, "GetNamedFramebufferAttachmentParameteriv", &[]));
    _GetNamedFramebufferParameteriv = transmute(load(func, "GetNamedFramebufferParameteriv", &[]));
    _GetNamedRenderbufferParameteriv =
        transmute(load(func, "GetNamedRenderbufferParameteriv", &[]));
    ...
    _GetPointerv = transmute(load(
        func,
        "GetPointerv",
        &["GetPointervEXT", "GetPointervKHR"],
    ));
    ...
    _GetProgramResourceLocationIndex =
        transmute(load(func, "GetProgramResourceLocationIndex", &[]));
    ...
    _GetQueryObjectiv = transmute(load(
        func,
        "GetQueryObjectiv",
        &["GetQueryObjectivARB", "GetQueryObjectivEXT"],
    ));
    _GetQueryObjectui64v = transmute(load(
        func,
        "GetQueryObjectui64v",
    ...
    _GetRenderbufferParameteriv = transmute(load(
        func,
        "GetRenderbufferParameteriv",
        &["GetRenderbufferParameterivEXT"],
    ));
    _GetSamplerParameterIiv = transmute(load(
        func,
        "GetSamplerParameterIiv",
        &["GetSamplerParameterIivEXT", "GetSamplerParameterIivOES"],
    ));
    _GetSamplerParameterIuiv = transmute(load(
        func,
        "GetSamplerParameterIuiv",
        &["GetSamplerParameterIuivEXT", "GetSamplerParameterIuivOES"],
    ));
    ...
    _GetTexParameterIiv = transmute(load(
        func,
        "GetTexParameterIiv",
        &["GetTexParameterIivEXT", "GetTexParameterIivOES"],
    ));
    _GetTexParameterIuiv = transmute(load(
        func,
        "GetTexParameterIuiv",
        &["GetTexParameterIuivEXT", "GetTexParameterIuivOES"],
    ));
    ...
    _GetTransformFeedbackVarying = transmute(load(
        func,
    ...
    _GetVertexAttribIuiv = transmute(load(
        func,
        "GetVertexAttribIuiv",
        &["GetVertexAttribIuivEXT"],
    ));
    _GetVertexAttribLdv = transmute(load(func, "GetVertexAttribLdv", &["GetVertexAttribLdvEXT"]));
    _GetVertexAttribPointerv = transmute(load(
        func,
        "GetVertexAttribPointerv",
        &["GetVertexAttribPointervARB", "GetVertexAttribPointervNV"],
    ));
    _GetVertexAttribdv = transmute(load(
        func,
        "GetVertexAttribdv",
        &["GetVertexAttribdvARB", "GetVertexAttribdvNV"],
    ));
    _GetVertexAttribfv = transmute(load(
        func,
        "GetVertexAttribfv",
        &["GetVertexAttribfvARB", "GetVertexAttribfvNV"],
    ));
    _GetVertexAttribiv = transmute(load(
        func,
        "GetVertexAttribiv",
    ...
    _GetnUniformfv = transmute(load(
        func,
        "GetnUniformfv",
        &["GetnUniformfvEXT", "GetnUniformfvKHR"],
    ));
    _GetnUniformiv = transmute(load(
        func,
        "GetnUniformiv",
        &["GetnUniformivEXT", "GetnUniformivKHR"],
    ));
    ...
    _InvalidateNamedFramebufferSubData =
        transmute(load(func, "InvalidateNamedFramebufferSubData", &[]));
    ...
    _IsTransformFeedback = transmute(load(
        func,
        "IsTransformFeedback",
        &["IsTransformFeedbackNV"],
    ));
    _IsVertexArray = transmute(load(
        func,
        "IsVertexArray",
        &["IsVertexArrayAPPLE", "IsVertexArrayOES"],
    ));
    ...
    _MinSampleShading = transmute(load(
        func,
        "MinSampleShading",
        &["MinSampleShadingARB", "MinSampleShadingOES"],
    ));
    _MultiDrawArrays = transmute(load(func, "MultiDrawArrays", &["MultiDrawArraysEXT"]));
    _MultiDrawArraysIndirect = transmute(load(
        func,
        "MultiDrawArraysIndirect",
        &["MultiDrawArraysIndirectAMD", "MultiDrawArraysIndirectEXT"],
    ));
    _MultiDrawArraysIndirectCount = transmute(load(
        func,
    ...
    _MultiDrawElementsBaseVertex = transmute(load(
        func,
        "MultiDrawElementsBaseVertex",
        &["MultiDrawElementsBaseVertexEXT"],
    ));
    _MultiDrawElementsIndirect = transmute(load(
        func,
    ...
    _MultiDrawElementsIndirectCount = transmute(load(
        func,
    ...
    _NamedRenderbufferStorageMultisample =
        transmute(load(func, "NamedRenderbufferStorageMultisample", &[]));
    ...
    _PatchParameteri = transmute(load(
        func,
        "PatchParameteri",
        &["PatchParameteriEXT", "PatchParameteriOES"],
    ));
    _PauseTransformFeedback = transmute(load(
        func,
    ...
    _PointParameterf = transmute(load(
        func,
        "PointParameterf",
        &[
            "PointParameterfARB",
    ...
    _PointParameterfv = transmute(load(
        func,
        "PointParameterfv",
        &[
            "PointParameterfvARB",
    ...
    _ProgramParameteri = transmute(load(
        func,
        "ProgramParameteri",
        &["ProgramParameteriARB", "ProgramParameteriEXT"],
    ));
    ...
    _ReadnPixels = transmute(load(
        func,
        "ReadnPixels",
        &["ReadnPixelsARB", "ReadnPixelsEXT", "ReadnPixelsKHR"],
    ));
    _ReleaseShaderCompiler = transmute(load(func, "ReleaseShaderCompiler", &[]));
    _RenderbufferStorage = transmute(load(
        func,
        "RenderbufferStorage",
        &["RenderbufferStorageEXT"],
    ));
    _RenderbufferStorageMultisample = transmute(load(
        func,
    ...
    _ResumeTransformFeedback = transmute(load(
        func,
    ...
    _SamplerParameterIiv = transmute(load(
        func,
        "SamplerParameterIiv",
        &["SamplerParameterIivEXT", "SamplerParameterIivOES"],
    ));
    _SamplerParameterIuiv = transmute(load(
        func,
        "SamplerParameterIuiv",
        &["SamplerParameterIuivEXT", "SamplerParameterIuivOES"],
    ));
    ...
    _ScissorArrayv = transmute(load(
        func,
        "ScissorArrayv",
        &["ScissorArrayvNV", "ScissorArrayvOES"],
    ));
    _ScissorIndexed = transmute(load(
        func,
        "ScissorIndexed",
        &["ScissorIndexedNV", "ScissorIndexedOES"],
    ));
    _ScissorIndexedv = transmute(load(
        func,
        "ScissorIndexedv",
        &["ScissorIndexedvNV", "ScissorIndexedvOES"],
    ));
    ...
    _TexBuffer = transmute(load(
        func,
        "TexBuffer",
        &["TexBufferARB", "TexBufferEXT", "TexBufferOES"],
    ));
    _TexBufferRange = transmute(load(
        func,
        "TexBufferRange",
        &["TexBufferRangeEXT", "TexBufferRangeOES"],
    ));
    ...
    _TexParameterIiv = transmute(load(
        func,
        "TexParameterIiv",
        &["TexParameterIivEXT", "TexParameterIivOES"],
    ));
    _TexParameterIuiv = transmute(load(
        func,
        "TexParameterIuiv",
        &["TexParameterIuivEXT", "TexParameterIuivOES"],
    ));
    ...
    _TexStorage3DMultisample = transmute(load(
        func,
    ...
    _TextureView = transmute(load(
        func,
        "TextureView",
        &["TextureViewEXT", "TextureViewOES"],
    ));
    ...
    _TransformFeedbackVaryings = transmute(load(
        func,
    ...
    _VertexAttrib1d = transmute(load(
        func,
        "VertexAttrib1d",
        &["VertexAttrib1dARB", "VertexAttrib1dNV"],
    ));
    _VertexAttrib1dv = transmute(load(
        func,
        "VertexAttrib1dv",
        &["VertexAttrib1dvARB", "VertexAttrib1dvNV"],
    ));
    _VertexAttrib1f = transmute(load(
        func,
        "VertexAttrib1f",
        &["VertexAttrib1fARB", "VertexAttrib1fNV"],
    ));
    _VertexAttrib1fv = transmute(load(
        func,
        "VertexAttrib1fv",
        &["VertexAttrib1fvARB", "VertexAttrib1fvNV"],
    ));
    _VertexAttrib1s = transmute(load(
        func,
        "VertexAttrib1s",
        &["VertexAttrib1sARB", "VertexAttrib1sNV"],
    ));
    _VertexAttrib1sv = transmute(load(
        func,
        "VertexAttrib1sv",
        &["VertexAttrib1svARB", "VertexAttrib1svNV"],
    ));
    _VertexAttrib2d = transmute(load(
        func,
        "VertexAttrib2d",
        &["VertexAttrib2dARB", "VertexAttrib2dNV"],
    ));
    _VertexAttrib2dv = transmute(load(
        func,
        "VertexAttrib2dv",
        &["VertexAttrib2dvARB", "VertexAttrib2dvNV"],
    ));
    _VertexAttrib2f = transmute(load(
        func,
        "VertexAttrib2f",
        &["VertexAttrib2fARB", "VertexAttrib2fNV"],
    ));
    _VertexAttrib2fv = transmute(load(
        func,
        "VertexAttrib2fv",
        &["VertexAttrib2fvARB", "VertexAttrib2fvNV"],
    ));
    _VertexAttrib2s = transmute(load(
        func,
        "VertexAttrib2s",
        &["VertexAttrib2sARB", "VertexAttrib2sNV"],
    ));
    _VertexAttrib2sv = transmute(load(
        func,
        "VertexAttrib2sv",
        &["VertexAttrib2svARB", "VertexAttrib2svNV"],
    ));
    _VertexAttrib3d = transmute(load(
        func,
        "VertexAttrib3d",
        &["VertexAttrib3dARB", "VertexAttrib3dNV"],
    ));
    _VertexAttrib3dv = transmute(load(
        func,
        "VertexAttrib3dv",
        &["VertexAttrib3dvARB", "VertexAttrib3dvNV"],
    ));
    _VertexAttrib3f = transmute(load(
        func,
        "VertexAttrib3f",
        &["VertexAttrib3fARB", "VertexAttrib3fNV"],
    ));
    _VertexAttrib3fv = transmute(load(
        func,
        "VertexAttrib3fv",
        &["VertexAttrib3fvARB", "VertexAttrib3fvNV"],
    ));
    _VertexAttrib3s = transmute(load(
        func,
        "VertexAttrib3s",
        &["VertexAttrib3sARB", "VertexAttrib3sNV"],
    ));
    _VertexAttrib3sv = transmute(load(
        func,
        "VertexAttrib3sv",
        &["VertexAttrib3svARB", "VertexAttrib3svNV"],
    ));
    ...
    _VertexAttrib4Nub = transmute(load(
        func,
        "VertexAttrib4Nub",
        &["VertexAttrib4NubARB", "VertexAttrib4ubNV"],
    ));
    _VertexAttrib4Nubv = transmute(load(
        func,
        "VertexAttrib4Nubv",
        &["VertexAttrib4NubvARB", "VertexAttrib4ubvNV"],
    ));
    ...
    _VertexAttrib4d = transmute(load(
        func,
        "VertexAttrib4d",
        &["VertexAttrib4dARB", "VertexAttrib4dNV"],
    ));
    _VertexAttrib4dv = transmute(load(
        func,
        "VertexAttrib4dv",
        &["VertexAttrib4dvARB", "VertexAttrib4dvNV"],
    ));
    _VertexAttrib4f = transmute(load(
        func,
        "VertexAttrib4f",
        &["VertexAttrib4fARB", "VertexAttrib4fNV"],
    ));
    _VertexAttrib4fv = transmute(load(
        func,
        "VertexAttrib4fv",
        &["VertexAttrib4fvARB", "VertexAttrib4fvNV"],
    ));
    _VertexAttrib4iv = transmute(load(func, "VertexAttrib4iv", &["VertexAttrib4ivARB"]));
    _VertexAttrib4s = transmute(load(
        func,
        "VertexAttrib4s",
        &["VertexAttrib4sARB", "VertexAttrib4sNV"],
    ));
    _VertexAttrib4sv = transmute(load(
        func,
        "VertexAttrib4sv",
        &["VertexAttrib4svARB", "VertexAttrib4svNV"],
    ));
    ...
    _VertexAttribDivisor = transmute(load(
        func,
        "VertexAttribDivisor",
        &[
    ...
    _VertexAttribIPointer = transmute(load(
        func,
    ...
    _VertexAttribLPointer = transmute(load(
        func,
    ...
    _VertexAttribPointer = transmute(load(
        func,
        "VertexAttribPointer",
    ...
    _ViewportArrayv = transmute(load(
        func,
        "ViewportArrayv",
        &["ViewportArrayvNV", "ViewportArrayvOES"],
    ));
    _ViewportIndexedf = transmute(load(
        func,
        "ViewportIndexedf",
        &["ViewportIndexedfOES", "ViewportIndexedfNV"],
    ));
    _ViewportIndexedfv = transmute(load(
        func,
        "ViewportIndexedfv",
        &["ViewportIndexedfvOES", "ViewportIndexedfvNV"],
    ));
