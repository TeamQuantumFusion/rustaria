...
use crate::{
	...
	ffi,
	types::LuaPointer,
	util::{check_stack, error_traceback, pop_error, StackGuard},
	value::{FromLuaMulti, ToLuaMulti},
};
...
impl<R> AsyncThread<R> {
	#[inline]
	pub(crate) fn set_recyclable(&mut self, recyclable: bool) { self.recycle = recyclable; }
}
