...
const COMPAT53_LEVELS1: c_int = 12;
...
#[inline(always)]
pub unsafe fn lua_rawlen(L: *mut lua_State, idx: c_int) -> usize { lua_objlen(L, idx) }
...
#[inline(always)]
pub unsafe fn lua_pushglobaltable(L: *mut lua_State) { lua_pushvalue(L, LUA_GLOBALSINDEX); }
