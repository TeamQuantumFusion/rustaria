...
use std::{
	...
	mem,
	os::raw::{c_char, c_double, c_int, c_uchar, c_ushort, c_void},
	ptr,
};
...
pub const fn lua_upvalueindex(i: c_int) -> c_int { LUA_REGISTRYINDEX - i }
...
#[inline(always)]
pub unsafe fn lua_call(L: *mut lua_State, n: c_int, r: c_int) { lua_callk(L, n, r, 0, None) }
...
#[inline(always)]
pub unsafe fn lua_yield(L: *mut lua_State, n: c_int) -> c_int { lua_yieldk(L, n, 0, None) }
...
#[inline(always)]
pub unsafe fn lua_insert(L: *mut lua_State, idx: c_int) { lua_rotate(L, idx, 1) }
