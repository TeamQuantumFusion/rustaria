...
pub unsafe fn load_gl<F: FnMut(&'static str) -> *const c_void>(func: &mut F) {_ActiveShaderProgram = transmute(load(func, "glActiveShaderProgram", &[]));
_ActiveTexture = transmute(load(func, "glActiveTexture", &["glActiveTextureARB"]));
_AttachShader = transmute(load(func, "glAttachShader", &["glAttachObjectARB"]));
_BeginConditionalRender = transmute(load(func, "glBeginConditionalRender", &["glBeginConditionalRenderNV"]));
_BeginQuery = transmute(load(func, "glBeginQuery", &["glBeginQueryARB"]));
_BeginQueryIndexed = transmute(load(func, "glBeginQueryIndexed", &[]));
_BeginTransformFeedback = transmute(load(func, "glBeginTransformFeedback", &["glBeginTransformFeedbackEXT", "glBeginTransformFeedbackNV"]));
_BindAttribLocation = transmute(load(func, "glBindAttribLocation", &["glBindAttribLocationARB"]));
_BindBuffer = transmute(load(func, "glBindBuffer", &["glBindBufferARB"]));
_BindBufferBase = transmute(load(func, "glBindBufferBase", &["glBindBufferBaseEXT", "glBindBufferBaseNV"]));
_BindBufferRange = transmute(load(func, "glBindBufferRange", &["glBindBufferRangeEXT", "glBindBufferRangeNV"]));
_BindBuffersBase = transmute(load(func, "glBindBuffersBase", &[]));
_BindBuffersRange = transmute(load(func, "glBindBuffersRange", &[]));
_BindFragDataLocation = transmute(load(func, "glBindFragDataLocation", &["glBindFragDataLocationEXT"]));
_BindFragDataLocationIndexed = transmute(load(func, "glBindFragDataLocationIndexed", &["glBindFragDataLocationIndexedEXT"]));
_BindFramebuffer = transmute(load(func, "glBindFramebuffer", &[]));
_BindImageTexture = transmute(load(func, "glBindImageTexture", &[]));
_BindImageTextures = transmute(load(func, "glBindImageTextures", &[]));
_BindProgramPipeline = transmute(load(func, "glBindProgramPipeline", &[]));
_BindRenderbuffer = transmute(load(func, "glBindRenderbuffer", &[]));
_BindSampler = transmute(load(func, "glBindSampler", &[]));
_BindSamplers = transmute(load(func, "glBindSamplers", &[]));
_BindTexture = transmute(load(func, "glBindTexture", &["glBindTextureEXT"]));
_BindTextureUnit = transmute(load(func, "glBindTextureUnit", &[]));
_BindTextures = transmute(load(func, "glBindTextures", &[]));
_BindTransformFeedback = transmute(load(func, "glBindTransformFeedback", &[]));
_BindVertexArray = transmute(load(func, "glBindVertexArray", &["glBindVertexArrayOES"]));
_BindVertexBuffer = transmute(load(func, "glBindVertexBuffer", &[]));
_BindVertexBuffers = transmute(load(func, "glBindVertexBuffers", &[]));
_BlendColor = transmute(load(func, "glBlendColor", &["glBlendColorEXT"]));
_BlendEquation = transmute(load(func, "glBlendEquation", &["glBlendEquationEXT"]));
_BlendEquationSeparate = transmute(load(func, "glBlendEquationSeparate", &["glBlendEquationSeparateEXT"]));
_BlendEquationSeparatei = transmute(load(func, "glBlendEquationSeparatei", &["glBlendEquationSeparateIndexedAMD", "glBlendEquationSeparateiARB", "glBlendEquationSeparateiEXT", "glBlendEquationSeparateiOES"]));
_BlendEquationi = transmute(load(func, "glBlendEquationi", &["glBlendEquationIndexedAMD", "glBlendEquationiARB", "glBlendEquationiEXT", "glBlendEquationiOES"]));
_BlendFunc = transmute(load(func, "glBlendFunc", &[]));
_BlendFuncSeparate = transmute(load(func, "glBlendFuncSeparate", &["glBlendFuncSeparateEXT", "glBlendFuncSeparateINGR"]));
_BlendFuncSeparatei = transmute(load(func, "glBlendFuncSeparatei", &["glBlendFuncSeparateIndexedAMD", "glBlendFuncSeparateiARB", "glBlendFuncSeparateiEXT", "glBlendFuncSeparateiOES"]));
_BlendFunci = transmute(load(func, "glBlendFunci", &["glBlendFuncIndexedAMD", "glBlendFunciARB", "glBlendFunciEXT", "glBlendFunciOES"]));
_BlitFramebuffer = transmute(load(func, "glBlitFramebuffer", &["glBlitFramebufferEXT", "glBlitFramebufferNV"]));
_BlitNamedFramebuffer = transmute(load(func, "glBlitNamedFramebuffer", &[]));
_BufferData = transmute(load(func, "glBufferData", &["glBufferDataARB"]));
_BufferStorage = transmute(load(func, "glBufferStorage", &["glBufferStorageEXT"]));
_BufferSubData = transmute(load(func, "glBufferSubData", &["glBufferSubDataARB"]));
_CheckFramebufferStatus = transmute(load(func, "glCheckFramebufferStatus", &["glCheckFramebufferStatusEXT"]));
_CheckNamedFramebufferStatus = transmute(load(func, "glCheckNamedFramebufferStatus", &[]));
_ClampColor = transmute(load(func, "glClampColor", &["glClampColorARB"]));
_Clear = transmute(load(func, "glClear", &[]));
_ClearBufferData = transmute(load(func, "glClearBufferData", &[]));
_ClearBufferSubData = transmute(load(func, "glClearBufferSubData", &[]));
_ClearBufferfi = transmute(load(func, "glClearBufferfi", &[]));
_ClearBufferfv = transmute(load(func, "glClearBufferfv", &[]));
_ClearBufferiv = transmute(load(func, "glClearBufferiv", &[]));
_ClearBufferuiv = transmute(load(func, "glClearBufferuiv", &[]));
_ClearColor = transmute(load(func, "glClearColor", &[]));
_ClearDepth = transmute(load(func, "glClearDepth", &[]));
_ClearDepthf = transmute(load(func, "glClearDepthf", &["glClearDepthfOES"]));
_ClearNamedBufferData = transmute(load(func, "glClearNamedBufferData", &[]));
_ClearNamedBufferSubData = transmute(load(func, "glClearNamedBufferSubData", &[]));
_ClearNamedFramebufferfi = transmute(load(func, "glClearNamedFramebufferfi", &[]));
_ClearNamedFramebufferfv = transmute(load(func, "glClearNamedFramebufferfv", &[]));
_ClearNamedFramebufferiv = transmute(load(func, "glClearNamedFramebufferiv", &[]));
_ClearNamedFramebufferuiv = transmute(load(func, "glClearNamedFramebufferuiv", &[]));
_ClearStencil = transmute(load(func, "glClearStencil", &[]));
_ClearTexImage = transmute(load(func, "glClearTexImage", &["glClearTexImageEXT"]));
_ClearTexSubImage = transmute(load(func, "glClearTexSubImage", &["glClearTexSubImageEXT"]));
_ClientWaitSync = transmute(load(func, "glClientWaitSync", &["glClientWaitSyncAPPLE"]));
_ClipControl = transmute(load(func, "glClipControl", &["glClipControlEXT"]));
_ColorMask = transmute(load(func, "glColorMask", &[]));
_ColorMaski = transmute(load(func, "glColorMaski", &["glColorMaskIndexedEXT", "glColorMaskiEXT", "glColorMaskiOES"]));
_ColorP3ui = transmute(load(func, "glColorP3ui", &[]));
_ColorP3uiv = transmute(load(func, "glColorP3uiv", &[]));
_ColorP4ui = transmute(load(func, "glColorP4ui", &[]));
_ColorP4uiv = transmute(load(func, "glColorP4uiv", &[]));
_CompileShader = transmute(load(func, "glCompileShader", &["glCompileShaderARB"]));
_CompressedTexImage1D = transmute(load(func, "glCompressedTexImage1D", &["glCompressedTexImage1DARB"]));
_CompressedTexImage2D = transmute(load(func, "glCompressedTexImage2D", &["glCompressedTexImage2DARB"]));
_CompressedTexImage3D = transmute(load(func, "glCompressedTexImage3D", &["glCompressedTexImage3DARB"]));
_CompressedTexSubImage1D = transmute(load(func, "glCompressedTexSubImage1D", &["glCompressedTexSubImage1DARB"]));
_CompressedTexSubImage2D = transmute(load(func, "glCompressedTexSubImage2D", &["glCompressedTexSubImage2DARB"]));
_CompressedTexSubImage3D = transmute(load(func, "glCompressedTexSubImage3D", &["glCompressedTexSubImage3DARB"]));
_CompressedTextureSubImage1D = transmute(load(func, "glCompressedTextureSubImage1D", &[]));
_CompressedTextureSubImage2D = transmute(load(func, "glCompressedTextureSubImage2D", &[]));
_CompressedTextureSubImage3D = transmute(load(func, "glCompressedTextureSubImage3D", &[]));
_CopyBufferSubData = transmute(load(func, "glCopyBufferSubData", &["glCopyBufferSubDataNV"]));
_CopyImageSubData = transmute(load(func, "glCopyImageSubData", &["glCopyImageSubDataEXT", "glCopyImageSubDataOES"]));
_CopyNamedBufferSubData = transmute(load(func, "glCopyNamedBufferSubData", &[]));
_CopyTexImage1D = transmute(load(func, "glCopyTexImage1D", &["glCopyTexImage1DEXT"]));
_CopyTexImage2D = transmute(load(func, "glCopyTexImage2D", &["glCopyTexImage2DEXT"]));
_CopyTexSubImage1D = transmute(load(func, "glCopyTexSubImage1D", &["glCopyTexSubImage1DEXT"]));
_CopyTexSubImage2D = transmute(load(func, "glCopyTexSubImage2D", &["glCopyTexSubImage2DEXT"]));
_CopyTexSubImage3D = transmute(load(func, "glCopyTexSubImage3D", &["glCopyTexSubImage3DEXT"]));
_CopyTextureSubImage1D = transmute(load(func, "glCopyTextureSubImage1D", &[]));
_CopyTextureSubImage2D = transmute(load(func, "glCopyTextureSubImage2D", &[]));
_CopyTextureSubImage3D = transmute(load(func, "glCopyTextureSubImage3D", &[]));
_CreateBuffers = transmute(load(func, "glCreateBuffers", &[]));
_CreateFramebuffers = transmute(load(func, "glCreateFramebuffers", &[]));
_CreateProgram = transmute(load(func, "glCreateProgram", &["glCreateProgramObjectARB"]));
_CreateProgramPipelines = transmute(load(func, "glCreateProgramPipelines", &[]));
_CreateQueries = transmute(load(func, "glCreateQueries", &[]));
_CreateRenderbuffers = transmute(load(func, "glCreateRenderbuffers", &[]));
_CreateSamplers = transmute(load(func, "glCreateSamplers", &[]));
_CreateShader = transmute(load(func, "glCreateShader", &["glCreateShaderObjectARB"]));
_CreateShaderProgramv = transmute(load(func, "glCreateShaderProgramv", &[]));
_CreateTextures = transmute(load(func, "glCreateTextures", &[]));
_CreateTransformFeedbacks = transmute(load(func, "glCreateTransformFeedbacks", &[]));
_CreateVertexArrays = transmute(load(func, "glCreateVertexArrays", &[]));
_CullFace = transmute(load(func, "glCullFace", &[]));
_DebugMessageCallback = transmute(load(func, "glDebugMessageCallback", &["glDebugMessageCallbackARB", "glDebugMessageCallbackKHR"]));
_DebugMessageControl = transmute(load(func, "glDebugMessageControl", &["glDebugMessageControlARB", "glDebugMessageControlKHR"]));
_DebugMessageInsert = transmute(load(func, "glDebugMessageInsert", &["glDebugMessageInsertARB", "glDebugMessageInsertKHR"]));
_DeleteBuffers = transmute(load(func, "glDeleteBuffers", &["glDeleteBuffersARB"]));
_DeleteFramebuffers = transmute(load(func, "glDeleteFramebuffers", &["glDeleteFramebuffersEXT"]));
_DeleteProgram = transmute(load(func, "glDeleteProgram", &[]));
_DeleteProgramPipelines = transmute(load(func, "glDeleteProgramPipelines", &[]));
_DeleteQueries = transmute(load(func, "glDeleteQueries", &["glDeleteQueriesARB"]));
_DeleteRenderbuffers = transmute(load(func, "glDeleteRenderbuffers", &["glDeleteRenderbuffersEXT"]));
_DeleteSamplers = transmute(load(func, "glDeleteSamplers", &[]));
_DeleteShader = transmute(load(func, "glDeleteShader", &[]));
_DeleteSync = transmute(load(func, "glDeleteSync", &["glDeleteSyncAPPLE"]));
_DeleteTextures = transmute(load(func, "glDeleteTextures", &[]));
_DeleteTransformFeedbacks = transmute(load(func, "glDeleteTransformFeedbacks", &["glDeleteTransformFeedbacksNV"]));
_DeleteVertexArrays = transmute(load(func, "glDeleteVertexArrays", &["glDeleteVertexArraysAPPLE", "glDeleteVertexArraysOES"]));
_DepthFunc = transmute(load(func, "glDepthFunc", &[]));
_DepthMask = transmute(load(func, "glDepthMask", &[]));
_DepthRange = transmute(load(func, "glDepthRange", &[]));
_DepthRangeArrayv = transmute(load(func, "glDepthRangeArrayv", &[]));
_DepthRangeIndexed = transmute(load(func, "glDepthRangeIndexed", &[]));
_DepthRangef = transmute(load(func, "glDepthRangef", &["glDepthRangefOES"]));
_DetachShader = transmute(load(func, "glDetachShader", &["glDetachObjectARB"]));
_Disable = transmute(load(func, "glDisable", &[]));
_DisableVertexArrayAttrib = transmute(load(func, "glDisableVertexArrayAttrib", &[]));
_DisableVertexAttribArray = transmute(load(func, "glDisableVertexAttribArray", &["glDisableVertexAttribArrayARB"]));
_Disablei = transmute(load(func, "glDisablei", &["glDisableIndexedEXT", "glDisableiEXT", "glDisableiNV", "glDisableiOES"]));
_DispatchCompute = transmute(load(func, "glDispatchCompute", &[]));
_DispatchComputeIndirect = transmute(load(func, "glDispatchComputeIndirect", &[]));
_DrawArrays = transmute(load(func, "glDrawArrays", &["glDrawArraysEXT"]));
_DrawArraysIndirect = transmute(load(func, "glDrawArraysIndirect", &[]));
_DrawArraysInstanced = transmute(load(func, "glDrawArraysInstanced", &["glDrawArraysInstancedANGLE", "glDrawArraysInstancedARB", "glDrawArraysInstancedEXT", "glDrawArraysInstancedNV"]));
_DrawArraysInstancedBaseInstance = transmute(load(func, "glDrawArraysInstancedBaseInstance", &["glDrawArraysInstancedBaseInstanceEXT"]));
_DrawBuffer = transmute(load(func, "glDrawBuffer", &[]));
_DrawBuffers = transmute(load(func, "glDrawBuffers", &["glDrawBuffersARB", "glDrawBuffersATI", "glDrawBuffersEXT"]));
_DrawElements = transmute(load(func, "glDrawElements", &[]));
_DrawElementsBaseVertex = transmute(load(func, "glDrawElementsBaseVertex", &["glDrawElementsBaseVertexEXT", "glDrawElementsBaseVertexOES"]));
_DrawElementsIndirect = transmute(load(func, "glDrawElementsIndirect", &[]));
_DrawElementsInstanced = transmute(load(func, "glDrawElementsInstanced", &["glDrawElementsInstancedANGLE", "glDrawElementsInstancedARB", "glDrawElementsInstancedEXT", "glDrawElementsInstancedNV"]));
_DrawElementsInstancedBaseInstance = transmute(load(func, "glDrawElementsInstancedBaseInstance", &["glDrawElementsInstancedBaseInstanceEXT"]));
_DrawElementsInstancedBaseVertex = transmute(load(func, "glDrawElementsInstancedBaseVertex", &["glDrawElementsInstancedBaseVertexEXT", "glDrawElementsInstancedBaseVertexOES"]));
_DrawElementsInstancedBaseVertexBaseInstance = transmute(load(func, "glDrawElementsInstancedBaseVertexBaseInstance", &["glDrawElementsInstancedBaseVertexBaseInstanceEXT"]));
_DrawRangeElements = transmute(load(func, "glDrawRangeElements", &["glDrawRangeElementsEXT"]));
_DrawRangeElementsBaseVertex = transmute(load(func, "glDrawRangeElementsBaseVertex", &["glDrawRangeElementsBaseVertexEXT", "glDrawRangeElementsBaseVertexOES"]));
_DrawTransformFeedback = transmute(load(func, "glDrawTransformFeedback", &["glDrawTransformFeedbackEXT", "glDrawTransformFeedbackNV"]));
_DrawTransformFeedbackInstanced = transmute(load(func, "glDrawTransformFeedbackInstanced", &["glDrawTransformFeedbackInstancedEXT"]));
_DrawTransformFeedbackStream = transmute(load(func, "glDrawTransformFeedbackStream", &[]));
_DrawTransformFeedbackStreamInstanced = transmute(load(func, "glDrawTransformFeedbackStreamInstanced", &[]));
_Enable = transmute(load(func, "glEnable", &[]));
_EnableVertexArrayAttrib = transmute(load(func, "glEnableVertexArrayAttrib", &[]));
_EnableVertexAttribArray = transmute(load(func, "glEnableVertexAttribArray", &["glEnableVertexAttribArrayARB"]));
_Enablei = transmute(load(func, "glEnablei", &["glEnableIndexedEXT", "glEnableiEXT", "glEnableiNV", "glEnableiOES"]));
_EndConditionalRender = transmute(load(func, "glEndConditionalRender", &["glEndConditionalRenderNV", "glEndConditionalRenderNVX"]));
_EndQuery = transmute(load(func, "glEndQuery", &["glEndQueryARB"]));
_EndQueryIndexed = transmute(load(func, "glEndQueryIndexed", &[]));
_EndTransformFeedback = transmute(load(func, "glEndTransformFeedback", &["glEndTransformFeedbackEXT", "glEndTransformFeedbackNV"]));
_FenceSync = transmute(load(func, "glFenceSync", &["glFenceSyncAPPLE"]));
_Finish = transmute(load(func, "glFinish", &[]));
_Flush = transmute(load(func, "glFlush", &[]));
_FlushMappedBufferRange = transmute(load(func, "glFlushMappedBufferRange", &["glFlushMappedBufferRangeAPPLE", "glFlushMappedBufferRangeEXT"]));
_FlushMappedNamedBufferRange = transmute(load(func, "glFlushMappedNamedBufferRange", &[]));
_FramebufferParameteri = transmute(load(func, "glFramebufferParameteri", &[]));
_FramebufferRenderbuffer = transmute(load(func, "glFramebufferRenderbuffer", &["glFramebufferRenderbufferEXT"]));
_FramebufferTexture = transmute(load(func, "glFramebufferTexture", &["glFramebufferTextureARB", "glFramebufferTextureEXT", "glFramebufferTextureOES"]));
_FramebufferTexture1D = transmute(load(func, "glFramebufferTexture1D", &["glFramebufferTexture1DEXT"]));
_FramebufferTexture2D = transmute(load(func, "glFramebufferTexture2D", &["glFramebufferTexture2DEXT"]));
_FramebufferTexture3D = transmute(load(func, "glFramebufferTexture3D", &["glFramebufferTexture3DEXT"]));
_FramebufferTextureLayer = transmute(load(func, "glFramebufferTextureLayer", &["glFramebufferTextureLayerARB", "glFramebufferTextureLayerEXT"]));
_FrontFace = transmute(load(func, "glFrontFace", &[]));
_GenBuffers = transmute(load(func, "glGenBuffers", &["glGenBuffersARB"]));
_GenFramebuffers = transmute(load(func, "glGenFramebuffers", &["glGenFramebuffersEXT"]));
_GenProgramPipelines = transmute(load(func, "glGenProgramPipelines", &[]));
_GenQueries = transmute(load(func, "glGenQueries", &["glGenQueriesARB"]));
_GenRenderbuffers = transmute(load(func, "glGenRenderbuffers", &["glGenRenderbuffersEXT"]));
_GenSamplers = transmute(load(func, "glGenSamplers", &[]));
_GenTextures = transmute(load(func, "glGenTextures", &[]));
_GenTransformFeedbacks = transmute(load(func, "glGenTransformFeedbacks", &["glGenTransformFeedbacksNV"]));
_GenVertexArrays = transmute(load(func, "glGenVertexArrays", &["glGenVertexArraysAPPLE", "glGenVertexArraysOES"]));
_GenerateMipmap = transmute(load(func, "glGenerateMipmap", &["glGenerateMipmapEXT"]));
_GenerateTextureMipmap = transmute(load(func, "glGenerateTextureMipmap", &[]));
_GetActiveAtomicCounterBufferiv = transmute(load(func, "glGetActiveAtomicCounterBufferiv", &[]));
_GetActiveAttrib = transmute(load(func, "glGetActiveAttrib", &["glGetActiveAttribARB"]));
_GetActiveSubroutineName = transmute(load(func, "glGetActiveSubroutineName", &[]));
_GetActiveSubroutineUniformName = transmute(load(func, "glGetActiveSubroutineUniformName", &[]));
_GetActiveSubroutineUniformiv = transmute(load(func, "glGetActiveSubroutineUniformiv", &[]));
_GetActiveUniform = transmute(load(func, "glGetActiveUniform", &["glGetActiveUniformARB"]));
_GetActiveUniformBlockName = transmute(load(func, "glGetActiveUniformBlockName", &[]));
_GetActiveUniformBlockiv = transmute(load(func, "glGetActiveUniformBlockiv", &[]));
_GetActiveUniformName = transmute(load(func, "glGetActiveUniformName", &[]));
_GetActiveUniformsiv = transmute(load(func, "glGetActiveUniformsiv", &[]));
_GetAttachedShaders = transmute(load(func, "glGetAttachedShaders", &[]));
_GetAttribLocation = transmute(load(func, "glGetAttribLocation", &["glGetAttribLocationARB"]));
_GetBooleani_v = transmute(load(func, "glGetBooleani_v", &["glGetBooleanIndexedvEXT"]));
_GetBooleanv = transmute(load(func, "glGetBooleanv", &[]));
_GetBufferParameteri64v = transmute(load(func, "glGetBufferParameteri64v", &[]));
_GetBufferParameteriv = transmute(load(func, "glGetBufferParameteriv", &["glGetBufferParameterivARB"]));
_GetBufferPointerv = transmute(load(func, "glGetBufferPointerv", &["glGetBufferPointervARB", "glGetBufferPointervOES"]));
_GetBufferSubData = transmute(load(func, "glGetBufferSubData", &["glGetBufferSubDataARB"]));
_GetCompressedTexImage = transmute(load(func, "glGetCompressedTexImage", &["glGetCompressedTexImageARB"]));
_GetCompressedTextureImage = transmute(load(func, "glGetCompressedTextureImage", &[]));
_GetCompressedTextureSubImage = transmute(load(func, "glGetCompressedTextureSubImage", &[]));
_GetDebugMessageLog = transmute(load(func, "glGetDebugMessageLog", &["glGetDebugMessageLogARB", "glGetDebugMessageLogKHR"]));
_GetDoublei_v = transmute(load(func, "glGetDoublei_v", &["glGetDoubleIndexedvEXT", "glGetDoublei_vEXT"]));
_GetDoublev = transmute(load(func, "glGetDoublev", &[]));
_GetError = transmute(load(func, "glGetError", &[]));
_GetFloati_v = transmute(load(func, "glGetFloati_v", &["glGetFloatIndexedvEXT", "glGetFloati_vEXT", "glGetFloati_vNV", "glGetFloati_vOES"]));
_GetFloatv = transmute(load(func, "glGetFloatv", &[]));
_GetFragDataIndex = transmute(load(func, "glGetFragDataIndex", &["glGetFragDataIndexEXT"]));
_GetFragDataLocation = transmute(load(func, "glGetFragDataLocation", &["glGetFragDataLocationEXT"]));
_GetFramebufferAttachmentParameteriv = transmute(load(func, "glGetFramebufferAttachmentParameteriv", &["glGetFramebufferAttachmentParameterivEXT"]));
_GetFramebufferParameteriv = transmute(load(func, "glGetFramebufferParameteriv", &[]));
_GetGraphicsResetStatus = transmute(load(func, "glGetGraphicsResetStatus", &["glGetGraphicsResetStatusEXT", "glGetGraphicsResetStatusKHR"]));
_GetInteger64i_v = transmute(load(func, "glGetInteger64i_v", &[]));
_GetInteger64v = transmute(load(func, "glGetInteger64v", &["glGetInteger64vAPPLE"]));
_GetIntegeri_v = transmute(load(func, "glGetIntegeri_v", &["glGetIntegerIndexedvEXT"]));
_GetIntegerv = transmute(load(func, "glGetIntegerv", &[]));
_GetInternalformati64v = transmute(load(func, "glGetInternalformati64v", &[]));
_GetInternalformativ = transmute(load(func, "glGetInternalformativ", &[]));
_GetMultisamplefv = transmute(load(func, "glGetMultisamplefv", &["glGetMultisamplefvNV"]));
_GetNamedBufferParameteri64v = transmute(load(func, "glGetNamedBufferParameteri64v", &[]));
_GetNamedBufferParameteriv = transmute(load(func, "glGetNamedBufferParameteriv", &[]));
_GetNamedBufferPointerv = transmute(load(func, "glGetNamedBufferPointerv", &[]));
_GetNamedBufferSubData = transmute(load(func, "glGetNamedBufferSubData", &[]));
_GetNamedFramebufferAttachmentParameteriv = transmute(load(func, "glGetNamedFramebufferAttachmentParameteriv", &[]));
_GetNamedFramebufferParameteriv = transmute(load(func, "glGetNamedFramebufferParameteriv", &[]));
_GetNamedRenderbufferParameteriv = transmute(load(func, "glGetNamedRenderbufferParameteriv", &[]));
_GetObjectLabel = transmute(load(func, "glGetObjectLabel", &["glGetObjectLabelKHR"]));
_GetObjectPtrLabel = transmute(load(func, "glGetObjectPtrLabel", &["glGetObjectPtrLabelKHR"]));
_GetPointerv = transmute(load(func, "glGetPointerv", &["glGetPointervEXT", "glGetPointervKHR"]));
_GetProgramBinary = transmute(load(func, "glGetProgramBinary", &["glGetProgramBinaryOES"]));
_GetProgramInfoLog = transmute(load(func, "glGetProgramInfoLog", &[]));
_GetProgramInterfaceiv = transmute(load(func, "glGetProgramInterfaceiv", &[]));
_GetProgramPipelineInfoLog = transmute(load(func, "glGetProgramPipelineInfoLog", &[]));
_GetProgramPipelineiv = transmute(load(func, "glGetProgramPipelineiv", &[]));
_GetProgramResourceIndex = transmute(load(func, "glGetProgramResourceIndex", &[]));
_GetProgramResourceLocation = transmute(load(func, "glGetProgramResourceLocation", &[]));
_GetProgramResourceLocationIndex = transmute(load(func, "glGetProgramResourceLocationIndex", &[]));
_GetProgramResourceName = transmute(load(func, "glGetProgramResourceName", &[]));
_GetProgramResourceiv = transmute(load(func, "glGetProgramResourceiv", &[]));
_GetProgramStageiv = transmute(load(func, "glGetProgramStageiv", &[]));
_GetProgramiv = transmute(load(func, "glGetProgramiv", &[]));
_GetQueryBufferObjecti64v = transmute(load(func, "glGetQueryBufferObjecti64v", &[]));
_GetQueryBufferObjectiv = transmute(load(func, "glGetQueryBufferObjectiv", &[]));
_GetQueryBufferObjectui64v = transmute(load(func, "glGetQueryBufferObjectui64v", &[]));
_GetQueryBufferObjectuiv = transmute(load(func, "glGetQueryBufferObjectuiv", &[]));
_GetQueryIndexediv = transmute(load(func, "glGetQueryIndexediv", &[]));
_GetQueryObjecti64v = transmute(load(func, "glGetQueryObjecti64v", &["glGetQueryObjecti64vEXT"]));
_GetQueryObjectiv = transmute(load(func, "glGetQueryObjectiv", &["glGetQueryObjectivARB", "glGetQueryObjectivEXT"]));
_GetQueryObjectui64v = transmute(load(func, "glGetQueryObjectui64v", &["glGetQueryObjectui64vEXT"]));
_GetQueryObjectuiv = transmute(load(func, "glGetQueryObjectuiv", &["glGetQueryObjectuivARB"]));
_GetQueryiv = transmute(load(func, "glGetQueryiv", &["glGetQueryivARB"]));
_GetRenderbufferParameteriv = transmute(load(func, "glGetRenderbufferParameteriv", &["glGetRenderbufferParameterivEXT"]));
_GetSamplerParameterIiv = transmute(load(func, "glGetSamplerParameterIiv", &["glGetSamplerParameterIivEXT", "glGetSamplerParameterIivOES"]));
_GetSamplerParameterIuiv = transmute(load(func, "glGetSamplerParameterIuiv", &["glGetSamplerParameterIuivEXT", "glGetSamplerParameterIuivOES"]));
_GetSamplerParameterfv = transmute(load(func, "glGetSamplerParameterfv", &[]));
_GetSamplerParameteriv = transmute(load(func, "glGetSamplerParameteriv", &[]));
_GetShaderInfoLog = transmute(load(func, "glGetShaderInfoLog", &[]));
_GetShaderPrecisionFormat = transmute(load(func, "glGetShaderPrecisionFormat", &[]));
_GetShaderSource = transmute(load(func, "glGetShaderSource", &["glGetShaderSourceARB"]));
_GetShaderiv = transmute(load(func, "glGetShaderiv", &[]));
_GetString = transmute(load(func, "glGetString", &[]));
_GetStringi = transmute(load(func, "glGetStringi", &[]));
_GetSubroutineIndex = transmute(load(func, "glGetSubroutineIndex", &[]));
_GetSubroutineUniformLocation = transmute(load(func, "glGetSubroutineUniformLocation", &[]));
_GetSynciv = transmute(load(func, "glGetSynciv", &["glGetSyncivAPPLE"]));
_GetTexImage = transmute(load(func, "glGetTexImage", &[]));
_GetTexLevelParameterfv = transmute(load(func, "glGetTexLevelParameterfv", &[]));
_GetTexLevelParameteriv = transmute(load(func, "glGetTexLevelParameteriv", &[]));
_GetTexParameterIiv = transmute(load(func, "glGetTexParameterIiv", &["glGetTexParameterIivEXT", "glGetTexParameterIivOES"]));
_GetTexParameterIuiv = transmute(load(func, "glGetTexParameterIuiv", &["glGetTexParameterIuivEXT", "glGetTexParameterIuivOES"]));
_GetTexParameterfv = transmute(load(func, "glGetTexParameterfv", &[]));
_GetTexParameteriv = transmute(load(func, "glGetTexParameteriv", &[]));
_GetTextureImage = transmute(load(func, "glGetTextureImage", &[]));
_GetTextureLevelParameterfv = transmute(load(func, "glGetTextureLevelParameterfv", &[]));
_GetTextureLevelParameteriv = transmute(load(func, "glGetTextureLevelParameteriv", &[]));
_GetTextureParameterIiv = transmute(load(func, "glGetTextureParameterIiv", &[]));
_GetTextureParameterIuiv = transmute(load(func, "glGetTextureParameterIuiv", &[]));
_GetTextureParameterfv = transmute(load(func, "glGetTextureParameterfv", &[]));
_GetTextureParameteriv = transmute(load(func, "glGetTextureParameteriv", &[]));
_GetTextureSubImage = transmute(load(func, "glGetTextureSubImage", &[]));
_GetTransformFeedbackVarying = transmute(load(func, "glGetTransformFeedbackVarying", &["glGetTransformFeedbackVaryingEXT"]));
_GetTransformFeedbacki64_v = transmute(load(func, "glGetTransformFeedbacki64_v", &[]));
_GetTransformFeedbacki_v = transmute(load(func, "glGetTransformFeedbacki_v", &[]));
_GetTransformFeedbackiv = transmute(load(func, "glGetTransformFeedbackiv", &[]));
_GetUniformBlockIndex = transmute(load(func, "glGetUniformBlockIndex", &[]));
_GetUniformIndices = transmute(load(func, "glGetUniformIndices", &[]));
_GetUniformLocation = transmute(load(func, "glGetUniformLocation", &["glGetUniformLocationARB"]));
_GetUniformSubroutineuiv = transmute(load(func, "glGetUniformSubroutineuiv", &[]));
_GetUniformdv = transmute(load(func, "glGetUniformdv", &[]));
_GetUniformfv = transmute(load(func, "glGetUniformfv", &["glGetUniformfvARB"]));
_GetUniformiv = transmute(load(func, "glGetUniformiv", &["glGetUniformivARB"]));
_GetUniformuiv = transmute(load(func, "glGetUniformuiv", &["glGetUniformuivEXT"]));
_GetVertexArrayIndexed64iv = transmute(load(func, "glGetVertexArrayIndexed64iv", &[]));
_GetVertexArrayIndexediv = transmute(load(func, "glGetVertexArrayIndexediv", &[]));
_GetVertexArrayiv = transmute(load(func, "glGetVertexArrayiv", &[]));
_GetVertexAttribIiv = transmute(load(func, "glGetVertexAttribIiv", &["glGetVertexAttribIivEXT"]));
_GetVertexAttribIuiv = transmute(load(func, "glGetVertexAttribIuiv", &["glGetVertexAttribIuivEXT"]));
_GetVertexAttribLdv = transmute(load(func, "glGetVertexAttribLdv", &["glGetVertexAttribLdvEXT"]));
_GetVertexAttribPointerv = transmute(load(func, "glGetVertexAttribPointerv", &["glGetVertexAttribPointervARB", "glGetVertexAttribPointervNV"]));
_GetVertexAttribdv = transmute(load(func, "glGetVertexAttribdv", &["glGetVertexAttribdvARB", "glGetVertexAttribdvNV"]));
_GetVertexAttribfv = transmute(load(func, "glGetVertexAttribfv", &["glGetVertexAttribfvARB", "glGetVertexAttribfvNV"]));
_GetVertexAttribiv = transmute(load(func, "glGetVertexAttribiv", &["glGetVertexAttribivARB", "glGetVertexAttribivNV"]));
_GetnColorTable = transmute(load(func, "glGetnColorTable", &[]));
_GetnCompressedTexImage = transmute(load(func, "glGetnCompressedTexImage", &[]));
_GetnConvolutionFilter = transmute(load(func, "glGetnConvolutionFilter", &[]));
_GetnHistogram = transmute(load(func, "glGetnHistogram", &[]));
_GetnMapdv = transmute(load(func, "glGetnMapdv", &[]));
_GetnMapfv = transmute(load(func, "glGetnMapfv", &[]));
_GetnMapiv = transmute(load(func, "glGetnMapiv", &[]));
_GetnMinmax = transmute(load(func, "glGetnMinmax", &[]));
_GetnPixelMapfv = transmute(load(func, "glGetnPixelMapfv", &[]));
_GetnPixelMapuiv = transmute(load(func, "glGetnPixelMapuiv", &[]));
_GetnPixelMapusv = transmute(load(func, "glGetnPixelMapusv", &[]));
_GetnPolygonStipple = transmute(load(func, "glGetnPolygonStipple", &[]));
_GetnSeparableFilter = transmute(load(func, "glGetnSeparableFilter", &[]));
_GetnTexImage = transmute(load(func, "glGetnTexImage", &[]));
_GetnUniformdv = transmute(load(func, "glGetnUniformdv", &[]));
_GetnUniformfv = transmute(load(func, "glGetnUniformfv", &["glGetnUniformfvEXT", "glGetnUniformfvKHR"]));
_GetnUniformiv = transmute(load(func, "glGetnUniformiv", &["glGetnUniformivEXT", "glGetnUniformivKHR"]));
_GetnUniformuiv = transmute(load(func, "glGetnUniformuiv", &["glGetnUniformuivKHR"]));
_Hint = transmute(load(func, "glHint", &[]));
_InvalidateBufferData = transmute(load(func, "glInvalidateBufferData", &[]));
_InvalidateBufferSubData = transmute(load(func, "glInvalidateBufferSubData", &[]));
_InvalidateFramebuffer = transmute(load(func, "glInvalidateFramebuffer", &[]));
_InvalidateNamedFramebufferData = transmute(load(func, "glInvalidateNamedFramebufferData", &[]));
_InvalidateNamedFramebufferSubData = transmute(load(func, "glInvalidateNamedFramebufferSubData", &[]));
_InvalidateSubFramebuffer = transmute(load(func, "glInvalidateSubFramebuffer", &[]));
_InvalidateTexImage = transmute(load(func, "glInvalidateTexImage", &[]));
_InvalidateTexSubImage = transmute(load(func, "glInvalidateTexSubImage", &[]));
_IsBuffer = transmute(load(func, "glIsBuffer", &["glIsBufferARB"]));
_IsEnabled = transmute(load(func, "glIsEnabled", &[]));
_IsEnabledi = transmute(load(func, "glIsEnabledi", &["glIsEnabledIndexedEXT", "glIsEnablediEXT", "glIsEnablediNV", "glIsEnablediOES"]));
_IsFramebuffer = transmute(load(func, "glIsFramebuffer", &["glIsFramebufferEXT"]));
_IsProgram = transmute(load(func, "glIsProgram", &[]));
_IsProgramPipeline = transmute(load(func, "glIsProgramPipeline", &[]));
_IsQuery = transmute(load(func, "glIsQuery", &["glIsQueryARB"]));
_IsRenderbuffer = transmute(load(func, "glIsRenderbuffer", &["glIsRenderbufferEXT"]));
_IsSampler = transmute(load(func, "glIsSampler", &[]));
_IsShader = transmute(load(func, "glIsShader", &[]));
_IsSync = transmute(load(func, "glIsSync", &["glIsSyncAPPLE"]));
_IsTexture = transmute(load(func, "glIsTexture", &[]));
_IsTransformFeedback = transmute(load(func, "glIsTransformFeedback", &["glIsTransformFeedbackNV"]));
_IsVertexArray = transmute(load(func, "glIsVertexArray", &["glIsVertexArrayAPPLE", "glIsVertexArrayOES"]));
_LineWidth = transmute(load(func, "glLineWidth", &[]));
_LinkProgram = transmute(load(func, "glLinkProgram", &["glLinkProgramARB"]));
_LogicOp = transmute(load(func, "glLogicOp", &[]));
_MapBuffer = transmute(load(func, "glMapBuffer", &["glMapBufferARB", "glMapBufferOES"]));
_MapBufferRange = transmute(load(func, "glMapBufferRange", &["glMapBufferRangeEXT"]));
_MapNamedBuffer = transmute(load(func, "glMapNamedBuffer", &[]));
_MapNamedBufferRange = transmute(load(func, "glMapNamedBufferRange", &[]));
_MemoryBarrier = transmute(load(func, "glMemoryBarrier", &["glMemoryBarrierEXT"]));
_MemoryBarrierByRegion = transmute(load(func, "glMemoryBarrierByRegion", &[]));
_MinSampleShading = transmute(load(func, "glMinSampleShading", &["glMinSampleShadingARB", "glMinSampleShadingOES"]));
_MultiDrawArrays = transmute(load(func, "glMultiDrawArrays", &["glMultiDrawArraysEXT"]));
_MultiDrawArraysIndirect = transmute(load(func, "glMultiDrawArraysIndirect", &["glMultiDrawArraysIndirectAMD", "glMultiDrawArraysIndirectEXT"]));
_MultiDrawArraysIndirectCount = transmute(load(func, "glMultiDrawArraysIndirectCount", &["glMultiDrawArraysIndirectCountARB"]));
_MultiDrawElements = transmute(load(func, "glMultiDrawElements", &["glMultiDrawElementsEXT"]));
_MultiDrawElementsBaseVertex = transmute(load(func, "glMultiDrawElementsBaseVertex", &["glMultiDrawElementsBaseVertexEXT"]));
_MultiDrawElementsIndirect = transmute(load(func, "glMultiDrawElementsIndirect", &["glMultiDrawElementsIndirectAMD", "glMultiDrawElementsIndirectEXT"]));
_MultiDrawElementsIndirectCount = transmute(load(func, "glMultiDrawElementsIndirectCount", &["glMultiDrawElementsIndirectCountARB"]));
_MultiTexCoordP1ui = transmute(load(func, "glMultiTexCoordP1ui", &[]));
_MultiTexCoordP1uiv = transmute(load(func, "glMultiTexCoordP1uiv", &[]));
_MultiTexCoordP2ui = transmute(load(func, "glMultiTexCoordP2ui", &[]));
_MultiTexCoordP2uiv = transmute(load(func, "glMultiTexCoordP2uiv", &[]));
_MultiTexCoordP3ui = transmute(load(func, "glMultiTexCoordP3ui", &[]));
_MultiTexCoordP3uiv = transmute(load(func, "glMultiTexCoordP3uiv", &[]));
_MultiTexCoordP4ui = transmute(load(func, "glMultiTexCoordP4ui", &[]));
_MultiTexCoordP4uiv = transmute(load(func, "glMultiTexCoordP4uiv", &[]));
_NamedBufferData = transmute(load(func, "glNamedBufferData", &[]));
_NamedBufferStorage = transmute(load(func, "glNamedBufferStorage", &["glNamedBufferStorageEXT"]));
_NamedBufferSubData = transmute(load(func, "glNamedBufferSubData", &["glNamedBufferSubDataEXT"]));
_NamedFramebufferDrawBuffer = transmute(load(func, "glNamedFramebufferDrawBuffer", &[]));
_NamedFramebufferDrawBuffers = transmute(load(func, "glNamedFramebufferDrawBuffers", &[]));
_NamedFramebufferParameteri = transmute(load(func, "glNamedFramebufferParameteri", &[]));
_NamedFramebufferReadBuffer = transmute(load(func, "glNamedFramebufferReadBuffer", &[]));
_NamedFramebufferRenderbuffer = transmute(load(func, "glNamedFramebufferRenderbuffer", &[]));
_NamedFramebufferTexture = transmute(load(func, "glNamedFramebufferTexture", &[]));
_NamedFramebufferTextureLayer = transmute(load(func, "glNamedFramebufferTextureLayer", &[]));
_NamedRenderbufferStorage = transmute(load(func, "glNamedRenderbufferStorage", &[]));
_NamedRenderbufferStorageMultisample = transmute(load(func, "glNamedRenderbufferStorageMultisample", &[]));
_NormalP3ui = transmute(load(func, "glNormalP3ui", &[]));
_NormalP3uiv = transmute(load(func, "glNormalP3uiv", &[]));
_ObjectLabel = transmute(load(func, "glObjectLabel", &["glObjectLabelKHR"]));
_ObjectPtrLabel = transmute(load(func, "glObjectPtrLabel", &["glObjectPtrLabelKHR"]));
_PatchParameterfv = transmute(load(func, "glPatchParameterfv", &[]));
_PatchParameteri = transmute(load(func, "glPatchParameteri", &["glPatchParameteriEXT", "glPatchParameteriOES"]));
_PauseTransformFeedback = transmute(load(func, "glPauseTransformFeedback", &["glPauseTransformFeedbackNV"]));
_PixelStoref = transmute(load(func, "glPixelStoref", &[]));
_PixelStorei = transmute(load(func, "glPixelStorei", &[]));
_PointParameterf = transmute(load(func, "glPointParameterf", &["glPointParameterfARB", "glPointParameterfEXT", "glPointParameterfSGIS"]));
_PointParameterfv = transmute(load(func, "glPointParameterfv", &["glPointParameterfvARB", "glPointParameterfvEXT", "glPointParameterfvSGIS"]));
_PointParameteri = transmute(load(func, "glPointParameteri", &["glPointParameteriNV"]));
_PointParameteriv = transmute(load(func, "glPointParameteriv", &["glPointParameterivNV"]));
_PointSize = transmute(load(func, "glPointSize", &[]));
_PolygonMode = transmute(load(func, "glPolygonMode", &["glPolygonModeNV"]));
_PolygonOffset = transmute(load(func, "glPolygonOffset", &[]));
_PolygonOffsetClamp = transmute(load(func, "glPolygonOffsetClamp", &["glPolygonOffsetClampEXT"]));
_PopDebugGroup = transmute(load(func, "glPopDebugGroup", &["glPopDebugGroupKHR"]));
_PrimitiveRestartIndex = transmute(load(func, "glPrimitiveRestartIndex", &[]));
_ProgramBinary = transmute(load(func, "glProgramBinary", &["glProgramBinaryOES"]));
_ProgramParameteri = transmute(load(func, "glProgramParameteri", &["glProgramParameteriARB", "glProgramParameteriEXT"]));
_ProgramUniform1d = transmute(load(func, "glProgramUniform1d", &[]));
_ProgramUniform1dv = transmute(load(func, "glProgramUniform1dv", &[]));
_ProgramUniform1f = transmute(load(func, "glProgramUniform1f", &["glProgramUniform1fEXT"]));
_ProgramUniform1fv = transmute(load(func, "glProgramUniform1fv", &["glProgramUniform1fvEXT"]));
_ProgramUniform1i = transmute(load(func, "glProgramUniform1i", &["glProgramUniform1iEXT"]));
_ProgramUniform1iv = transmute(load(func, "glProgramUniform1iv", &["glProgramUniform1ivEXT"]));
_ProgramUniform1ui = transmute(load(func, "glProgramUniform1ui", &["glProgramUniform1uiEXT"]));
_ProgramUniform1uiv = transmute(load(func, "glProgramUniform1uiv", &["glProgramUniform1uivEXT"]));
_ProgramUniform2d = transmute(load(func, "glProgramUniform2d", &[]));
_ProgramUniform2dv = transmute(load(func, "glProgramUniform2dv", &[]));
_ProgramUniform2f = transmute(load(func, "glProgramUniform2f", &["glProgramUniform2fEXT"]));
_ProgramUniform2fv = transmute(load(func, "glProgramUniform2fv", &["glProgramUniform2fvEXT"]));
_ProgramUniform2i = transmute(load(func, "glProgramUniform2i", &["glProgramUniform2iEXT"]));
_ProgramUniform2iv = transmute(load(func, "glProgramUniform2iv", &["glProgramUniform2ivEXT"]));
_ProgramUniform2ui = transmute(load(func, "glProgramUniform2ui", &["glProgramUniform2uiEXT"]));
_ProgramUniform2uiv = transmute(load(func, "glProgramUniform2uiv", &["glProgramUniform2uivEXT"]));
_ProgramUniform3d = transmute(load(func, "glProgramUniform3d", &[]));
_ProgramUniform3dv = transmute(load(func, "glProgramUniform3dv", &[]));
_ProgramUniform3f = transmute(load(func, "glProgramUniform3f", &["glProgramUniform3fEXT"]));
_ProgramUniform3fv = transmute(load(func, "glProgramUniform3fv", &["glProgramUniform3fvEXT"]));
_ProgramUniform3i = transmute(load(func, "glProgramUniform3i", &["glProgramUniform3iEXT"]));
_ProgramUniform3iv = transmute(load(func, "glProgramUniform3iv", &["glProgramUniform3ivEXT"]));
_ProgramUniform3ui = transmute(load(func, "glProgramUniform3ui", &["glProgramUniform3uiEXT"]));
_ProgramUniform3uiv = transmute(load(func, "glProgramUniform3uiv", &["glProgramUniform3uivEXT"]));
_ProgramUniform4d = transmute(load(func, "glProgramUniform4d", &[]));
_ProgramUniform4dv = transmute(load(func, "glProgramUniform4dv", &[]));
_ProgramUniform4f = transmute(load(func, "glProgramUniform4f", &["glProgramUniform4fEXT"]));
_ProgramUniform4fv = transmute(load(func, "glProgramUniform4fv", &["glProgramUniform4fvEXT"]));
_ProgramUniform4i = transmute(load(func, "glProgramUniform4i", &["glProgramUniform4iEXT"]));
_ProgramUniform4iv = transmute(load(func, "glProgramUniform4iv", &["glProgramUniform4ivEXT"]));
_ProgramUniform4ui = transmute(load(func, "glProgramUniform4ui", &["glProgramUniform4uiEXT"]));
_ProgramUniform4uiv = transmute(load(func, "glProgramUniform4uiv", &["glProgramUniform4uivEXT"]));
_ProgramUniformMatrix2dv = transmute(load(func, "glProgramUniformMatrix2dv", &[]));
_ProgramUniformMatrix2fv = transmute(load(func, "glProgramUniformMatrix2fv", &["glProgramUniformMatrix2fvEXT"]));
_ProgramUniformMatrix2x3dv = transmute(load(func, "glProgramUniformMatrix2x3dv", &[]));
_ProgramUniformMatrix2x3fv = transmute(load(func, "glProgramUniformMatrix2x3fv", &["glProgramUniformMatrix2x3fvEXT"]));
_ProgramUniformMatrix2x4dv = transmute(load(func, "glProgramUniformMatrix2x4dv", &[]));
_ProgramUniformMatrix2x4fv = transmute(load(func, "glProgramUniformMatrix2x4fv", &["glProgramUniformMatrix2x4fvEXT"]));
_ProgramUniformMatrix3dv = transmute(load(func, "glProgramUniformMatrix3dv", &[]));
_ProgramUniformMatrix3fv = transmute(load(func, "glProgramUniformMatrix3fv", &["glProgramUniformMatrix3fvEXT"]));
_ProgramUniformMatrix3x2dv = transmute(load(func, "glProgramUniformMatrix3x2dv", &[]));
_ProgramUniformMatrix3x2fv = transmute(load(func, "glProgramUniformMatrix3x2fv", &["glProgramUniformMatrix3x2fvEXT"]));
_ProgramUniformMatrix3x4dv = transmute(load(func, "glProgramUniformMatrix3x4dv", &[]));
_ProgramUniformMatrix3x4fv = transmute(load(func, "glProgramUniformMatrix3x4fv", &["glProgramUniformMatrix3x4fvEXT"]));
_ProgramUniformMatrix4dv = transmute(load(func, "glProgramUniformMatrix4dv", &[]));
_ProgramUniformMatrix4fv = transmute(load(func, "glProgramUniformMatrix4fv", &["glProgramUniformMatrix4fvEXT"]));
_ProgramUniformMatrix4x2dv = transmute(load(func, "glProgramUniformMatrix4x2dv", &[]));
_ProgramUniformMatrix4x2fv = transmute(load(func, "glProgramUniformMatrix4x2fv", &["glProgramUniformMatrix4x2fvEXT"]));
_ProgramUniformMatrix4x3dv = transmute(load(func, "glProgramUniformMatrix4x3dv", &[]));
_ProgramUniformMatrix4x3fv = transmute(load(func, "glProgramUniformMatrix4x3fv", &["glProgramUniformMatrix4x3fvEXT"]));
_ProvokingVertex = transmute(load(func, "glProvokingVertex", &["glProvokingVertexEXT"]));
_PushDebugGroup = transmute(load(func, "glPushDebugGroup", &["glPushDebugGroupKHR"]));
_QueryCounter = transmute(load(func, "glQueryCounter", &["glQueryCounterEXT"]));
_ReadBuffer = transmute(load(func, "glReadBuffer", &[]));
_ReadPixels = transmute(load(func, "glReadPixels", &[]));
_ReadnPixels = transmute(load(func, "glReadnPixels", &["glReadnPixelsARB", "glReadnPixelsEXT", "glReadnPixelsKHR"]));
_ReleaseShaderCompiler = transmute(load(func, "glReleaseShaderCompiler", &[]));
_RenderbufferStorage = transmute(load(func, "glRenderbufferStorage", &["glRenderbufferStorageEXT"]));
_RenderbufferStorageMultisample = transmute(load(func, "glRenderbufferStorageMultisample", &["glRenderbufferStorageMultisampleEXT", "glRenderbufferStorageMultisampleNV"]));
_ResumeTransformFeedback = transmute(load(func, "glResumeTransformFeedback", &["glResumeTransformFeedbackNV"]));
_SampleCoverage = transmute(load(func, "glSampleCoverage", &["glSampleCoverageARB"]));
_SampleMaski = transmute(load(func, "glSampleMaski", &[]));
_SamplerParameterIiv = transmute(load(func, "glSamplerParameterIiv", &["glSamplerParameterIivEXT", "glSamplerParameterIivOES"]));
_SamplerParameterIuiv = transmute(load(func, "glSamplerParameterIuiv", &["glSamplerParameterIuivEXT", "glSamplerParameterIuivOES"]));
_SamplerParameterf = transmute(load(func, "glSamplerParameterf", &[]));
_SamplerParameterfv = transmute(load(func, "glSamplerParameterfv", &[]));
_SamplerParameteri = transmute(load(func, "glSamplerParameteri", &[]));
_SamplerParameteriv = transmute(load(func, "glSamplerParameteriv", &[]));
_Scissor = transmute(load(func, "glScissor", &[]));
_ScissorArrayv = transmute(load(func, "glScissorArrayv", &["glScissorArrayvNV", "glScissorArrayvOES"]));
_ScissorIndexed = transmute(load(func, "glScissorIndexed", &["glScissorIndexedNV", "glScissorIndexedOES"]));
_ScissorIndexedv = transmute(load(func, "glScissorIndexedv", &["glScissorIndexedvNV", "glScissorIndexedvOES"]));
_SecondaryColorP3ui = transmute(load(func, "glSecondaryColorP3ui", &[]));
_SecondaryColorP3uiv = transmute(load(func, "glSecondaryColorP3uiv", &[]));
_ShaderBinary = transmute(load(func, "glShaderBinary", &[]));
_ShaderSource = transmute(load(func, "glShaderSource", &["glShaderSourceARB"]));
_ShaderStorageBlockBinding = transmute(load(func, "glShaderStorageBlockBinding", &[]));
_SpecializeShader = transmute(load(func, "glSpecializeShader", &["glSpecializeShaderARB"]));
_StencilFunc = transmute(load(func, "glStencilFunc", &[]));
_StencilFuncSeparate = transmute(load(func, "glStencilFuncSeparate", &[]));
_StencilMask = transmute(load(func, "glStencilMask", &[]));
_StencilMaskSeparate = transmute(load(func, "glStencilMaskSeparate", &[]));
_StencilOp = transmute(load(func, "glStencilOp", &[]));
_StencilOpSeparate = transmute(load(func, "glStencilOpSeparate", &["glStencilOpSeparateATI"]));
_TexBuffer = transmute(load(func, "glTexBuffer", &["glTexBufferARB", "glTexBufferEXT", "glTexBufferOES"]));
_TexBufferRange = transmute(load(func, "glTexBufferRange", &["glTexBufferRangeEXT", "glTexBufferRangeOES"]));
_TexCoordP1ui = transmute(load(func, "glTexCoordP1ui", &[]));
_TexCoordP1uiv = transmute(load(func, "glTexCoordP1uiv", &[]));
_TexCoordP2ui = transmute(load(func, "glTexCoordP2ui", &[]));
_TexCoordP2uiv = transmute(load(func, "glTexCoordP2uiv", &[]));
_TexCoordP3ui = transmute(load(func, "glTexCoordP3ui", &[]));
_TexCoordP3uiv = transmute(load(func, "glTexCoordP3uiv", &[]));
_TexCoordP4ui = transmute(load(func, "glTexCoordP4ui", &[]));
_TexCoordP4uiv = transmute(load(func, "glTexCoordP4uiv", &[]));
_TexImage1D = transmute(load(func, "glTexImage1D", &[]));
_TexImage2D = transmute(load(func, "glTexImage2D", &[]));
_TexImage2DMultisample = transmute(load(func, "glTexImage2DMultisample", &[]));
_TexImage3D = transmute(load(func, "glTexImage3D", &["glTexImage3DEXT"]));
_TexImage3DMultisample = transmute(load(func, "glTexImage3DMultisample", &[]));
_TexParameterIiv = transmute(load(func, "glTexParameterIiv", &["glTexParameterIivEXT", "glTexParameterIivOES"]));
_TexParameterIuiv = transmute(load(func, "glTexParameterIuiv", &["glTexParameterIuivEXT", "glTexParameterIuivOES"]));
_TexParameterf = transmute(load(func, "glTexParameterf", &[]));
_TexParameterfv = transmute(load(func, "glTexParameterfv", &[]));
_TexParameteri = transmute(load(func, "glTexParameteri", &[]));
_TexParameteriv = transmute(load(func, "glTexParameteriv", &[]));
_TexStorage1D = transmute(load(func, "glTexStorage1D", &["glTexStorage1DEXT"]));
_TexStorage2D = transmute(load(func, "glTexStorage2D", &["glTexStorage2DEXT"]));
_TexStorage2DMultisample = transmute(load(func, "glTexStorage2DMultisample", &[]));
_TexStorage3D = transmute(load(func, "glTexStorage3D", &["glTexStorage3DEXT"]));
_TexStorage3DMultisample = transmute(load(func, "glTexStorage3DMultisample", &["glTexStorage3DMultisampleOES"]));
_TexSubImage1D = transmute(load(func, "glTexSubImage1D", &["glTexSubImage1DEXT"]));
_TexSubImage2D = transmute(load(func, "glTexSubImage2D", &["glTexSubImage2DEXT"]));
_TexSubImage3D = transmute(load(func, "glTexSubImage3D", &["glTexSubImage3DEXT"]));
_TextureBarrier = transmute(load(func, "glTextureBarrier", &[]));
_TextureBuffer = transmute(load(func, "glTextureBuffer", &[]));
_TextureBufferRange = transmute(load(func, "glTextureBufferRange", &[]));
_TextureParameterIiv = transmute(load(func, "glTextureParameterIiv", &[]));
_TextureParameterIuiv = transmute(load(func, "glTextureParameterIuiv", &[]));
_TextureParameterf = transmute(load(func, "glTextureParameterf", &[]));
_TextureParameterfv = transmute(load(func, "glTextureParameterfv", &[]));
_TextureParameteri = transmute(load(func, "glTextureParameteri", &[]));
_TextureParameteriv = transmute(load(func, "glTextureParameteriv", &[]));
_TextureStorage1D = transmute(load(func, "glTextureStorage1D", &[]));
_TextureStorage2D = transmute(load(func, "glTextureStorage2D", &[]));
_TextureStorage2DMultisample = transmute(load(func, "glTextureStorage2DMultisample", &[]));
_TextureStorage3D = transmute(load(func, "glTextureStorage3D", &[]));
_TextureStorage3DMultisample = transmute(load(func, "glTextureStorage3DMultisample", &[]));
_TextureSubImage1D = transmute(load(func, "glTextureSubImage1D", &[]));
_TextureSubImage2D = transmute(load(func, "glTextureSubImage2D", &[]));
_TextureSubImage3D = transmute(load(func, "glTextureSubImage3D", &[]));
_TextureView = transmute(load(func, "glTextureView", &["glTextureViewEXT", "glTextureViewOES"]));
_TransformFeedbackBufferBase = transmute(load(func, "glTransformFeedbackBufferBase", &[]));
_TransformFeedbackBufferRange = transmute(load(func, "glTransformFeedbackBufferRange", &[]));
_TransformFeedbackVaryings = transmute(load(func, "glTransformFeedbackVaryings", &["glTransformFeedbackVaryingsEXT"]));
_Uniform1d = transmute(load(func, "glUniform1d", &[]));
_Uniform1dv = transmute(load(func, "glUniform1dv", &[]));
_Uniform1f = transmute(load(func, "glUniform1f", &["glUniform1fARB"]));
_Uniform1fv = transmute(load(func, "glUniform1fv", &["glUniform1fvARB"]));
_Uniform1i = transmute(load(func, "glUniform1i", &["glUniform1iARB"]));
_Uniform1iv = transmute(load(func, "glUniform1iv", &["glUniform1ivARB"]));
_Uniform1ui = transmute(load(func, "glUniform1ui", &["glUniform1uiEXT"]));
_Uniform1uiv = transmute(load(func, "glUniform1uiv", &["glUniform1uivEXT"]));
_Uniform2d = transmute(load(func, "glUniform2d", &[]));
_Uniform2dv = transmute(load(func, "glUniform2dv", &[]));
_Uniform2f = transmute(load(func, "glUniform2f", &["glUniform2fARB"]));
_Uniform2fv = transmute(load(func, "glUniform2fv", &["glUniform2fvARB"]));
_Uniform2i = transmute(load(func, "glUniform2i", &["glUniform2iARB"]));
_Uniform2iv = transmute(load(func, "glUniform2iv", &["glUniform2ivARB"]));
_Uniform2ui = transmute(load(func, "glUniform2ui", &["glUniform2uiEXT"]));
_Uniform2uiv = transmute(load(func, "glUniform2uiv", &["glUniform2uivEXT"]));
_Uniform3d = transmute(load(func, "glUniform3d", &[]));
_Uniform3dv = transmute(load(func, "glUniform3dv", &[]));
_Uniform3f = transmute(load(func, "glUniform3f", &["glUniform3fARB"]));
_Uniform3fv = transmute(load(func, "glUniform3fv", &["glUniform3fvARB"]));
_Uniform3i = transmute(load(func, "glUniform3i", &["glUniform3iARB"]));
_Uniform3iv = transmute(load(func, "glUniform3iv", &["glUniform3ivARB"]));
_Uniform3ui = transmute(load(func, "glUniform3ui", &["glUniform3uiEXT"]));
_Uniform3uiv = transmute(load(func, "glUniform3uiv", &["glUniform3uivEXT"]));
_Uniform4d = transmute(load(func, "glUniform4d", &[]));
_Uniform4dv = transmute(load(func, "glUniform4dv", &[]));
_Uniform4f = transmute(load(func, "glUniform4f", &["glUniform4fARB"]));
_Uniform4fv = transmute(load(func, "glUniform4fv", &["glUniform4fvARB"]));
_Uniform4i = transmute(load(func, "glUniform4i", &["glUniform4iARB"]));
_Uniform4iv = transmute(load(func, "glUniform4iv", &["glUniform4ivARB"]));
_Uniform4ui = transmute(load(func, "glUniform4ui", &["glUniform4uiEXT"]));
_Uniform4uiv = transmute(load(func, "glUniform4uiv", &["glUniform4uivEXT"]));
_UniformBlockBinding = transmute(load(func, "glUniformBlockBinding", &[]));
_UniformMatrix2dv = transmute(load(func, "glUniformMatrix2dv", &[]));
_UniformMatrix2fv = transmute(load(func, "glUniformMatrix2fv", &["glUniformMatrix2fvARB"]));
_UniformMatrix2x3dv = transmute(load(func, "glUniformMatrix2x3dv", &[]));
_UniformMatrix2x3fv = transmute(load(func, "glUniformMatrix2x3fv", &["glUniformMatrix2x3fvNV"]));
_UniformMatrix2x4dv = transmute(load(func, "glUniformMatrix2x4dv", &[]));
_UniformMatrix2x4fv = transmute(load(func, "glUniformMatrix2x4fv", &["glUniformMatrix2x4fvNV"]));
_UniformMatrix3dv = transmute(load(func, "glUniformMatrix3dv", &[]));
_UniformMatrix3fv = transmute(load(func, "glUniformMatrix3fv", &["glUniformMatrix3fvARB"]));
_UniformMatrix3x2dv = transmute(load(func, "glUniformMatrix3x2dv", &[]));
_UniformMatrix3x2fv = transmute(load(func, "glUniformMatrix3x2fv", &["glUniformMatrix3x2fvNV"]));
_UniformMatrix3x4dv = transmute(load(func, "glUniformMatrix3x4dv", &[]));
_UniformMatrix3x4fv = transmute(load(func, "glUniformMatrix3x4fv", &["glUniformMatrix3x4fvNV"]));
_UniformMatrix4dv = transmute(load(func, "glUniformMatrix4dv", &[]));
_UniformMatrix4fv = transmute(load(func, "glUniformMatrix4fv", &["glUniformMatrix4fvARB"]));
_UniformMatrix4x2dv = transmute(load(func, "glUniformMatrix4x2dv", &[]));
_UniformMatrix4x2fv = transmute(load(func, "glUniformMatrix4x2fv", &["glUniformMatrix4x2fvNV"]));
_UniformMatrix4x3dv = transmute(load(func, "glUniformMatrix4x3dv", &[]));
_UniformMatrix4x3fv = transmute(load(func, "glUniformMatrix4x3fv", &["glUniformMatrix4x3fvNV"]));
_UniformSubroutinesuiv = transmute(load(func, "glUniformSubroutinesuiv", &[]));
_UnmapBuffer = transmute(load(func, "glUnmapBuffer", &["glUnmapBufferARB", "glUnmapBufferOES"]));
_UnmapNamedBuffer = transmute(load(func, "glUnmapNamedBuffer", &[]));
_UseProgram = transmute(load(func, "glUseProgram", &["glUseProgramObjectARB"]));
_UseProgramStages = transmute(load(func, "glUseProgramStages", &[]));
_ValidateProgram = transmute(load(func, "glValidateProgram", &["glValidateProgramARB"]));
_ValidateProgramPipeline = transmute(load(func, "glValidateProgramPipeline", &[]));
_VertexArrayAttribBinding = transmute(load(func, "glVertexArrayAttribBinding", &[]));
_VertexArrayAttribFormat = transmute(load(func, "glVertexArrayAttribFormat", &[]));
_VertexArrayAttribIFormat = transmute(load(func, "glVertexArrayAttribIFormat", &[]));
_VertexArrayAttribLFormat = transmute(load(func, "glVertexArrayAttribLFormat", &[]));
_VertexArrayBindingDivisor = transmute(load(func, "glVertexArrayBindingDivisor", &[]));
_VertexArrayElementBuffer = transmute(load(func, "glVertexArrayElementBuffer", &[]));
_VertexArrayVertexBuffer = transmute(load(func, "glVertexArrayVertexBuffer", &[]));
_VertexArrayVertexBuffers = transmute(load(func, "glVertexArrayVertexBuffers", &[]));
_VertexAttrib1d = transmute(load(func, "glVertexAttrib1d", &["glVertexAttrib1dARB", "glVertexAttrib1dNV"]));
_VertexAttrib1dv = transmute(load(func, "glVertexAttrib1dv", &["glVertexAttrib1dvARB", "glVertexAttrib1dvNV"]));
_VertexAttrib1f = transmute(load(func, "glVertexAttrib1f", &["glVertexAttrib1fARB", "glVertexAttrib1fNV"]));
_VertexAttrib1fv = transmute(load(func, "glVertexAttrib1fv", &["glVertexAttrib1fvARB", "glVertexAttrib1fvNV"]));
_VertexAttrib1s = transmute(load(func, "glVertexAttrib1s", &["glVertexAttrib1sARB", "glVertexAttrib1sNV"]));
_VertexAttrib1sv = transmute(load(func, "glVertexAttrib1sv", &["glVertexAttrib1svARB", "glVertexAttrib1svNV"]));
_VertexAttrib2d = transmute(load(func, "glVertexAttrib2d", &["glVertexAttrib2dARB", "glVertexAttrib2dNV"]));
_VertexAttrib2dv = transmute(load(func, "glVertexAttrib2dv", &["glVertexAttrib2dvARB", "glVertexAttrib2dvNV"]));
_VertexAttrib2f = transmute(load(func, "glVertexAttrib2f", &["glVertexAttrib2fARB", "glVertexAttrib2fNV"]));
_VertexAttrib2fv = transmute(load(func, "glVertexAttrib2fv", &["glVertexAttrib2fvARB", "glVertexAttrib2fvNV"]));
_VertexAttrib2s = transmute(load(func, "glVertexAttrib2s", &["glVertexAttrib2sARB", "glVertexAttrib2sNV"]));
_VertexAttrib2sv = transmute(load(func, "glVertexAttrib2sv", &["glVertexAttrib2svARB", "glVertexAttrib2svNV"]));
_VertexAttrib3d = transmute(load(func, "glVertexAttrib3d", &["glVertexAttrib3dARB", "glVertexAttrib3dNV"]));
_VertexAttrib3dv = transmute(load(func, "glVertexAttrib3dv", &["glVertexAttrib3dvARB", "glVertexAttrib3dvNV"]));
_VertexAttrib3f = transmute(load(func, "glVertexAttrib3f", &["glVertexAttrib3fARB", "glVertexAttrib3fNV"]));
_VertexAttrib3fv = transmute(load(func, "glVertexAttrib3fv", &["glVertexAttrib3fvARB", "glVertexAttrib3fvNV"]));
_VertexAttrib3s = transmute(load(func, "glVertexAttrib3s", &["glVertexAttrib3sARB", "glVertexAttrib3sNV"]));
_VertexAttrib3sv = transmute(load(func, "glVertexAttrib3sv", &["glVertexAttrib3svARB", "glVertexAttrib3svNV"]));
_VertexAttrib4Nbv = transmute(load(func, "glVertexAttrib4Nbv", &["glVertexAttrib4NbvARB"]));
_VertexAttrib4Niv = transmute(load(func, "glVertexAttrib4Niv", &["glVertexAttrib4NivARB"]));
_VertexAttrib4Nsv = transmute(load(func, "glVertexAttrib4Nsv", &["glVertexAttrib4NsvARB"]));
_VertexAttrib4Nub = transmute(load(func, "glVertexAttrib4Nub", &["glVertexAttrib4NubARB", "glVertexAttrib4ubNV"]));
_VertexAttrib4Nubv = transmute(load(func, "glVertexAttrib4Nubv", &["glVertexAttrib4NubvARB", "glVertexAttrib4ubvNV"]));
_VertexAttrib4Nuiv = transmute(load(func, "glVertexAttrib4Nuiv", &["glVertexAttrib4NuivARB"]));
_VertexAttrib4Nusv = transmute(load(func, "glVertexAttrib4Nusv", &["glVertexAttrib4NusvARB"]));
_VertexAttrib4bv = transmute(load(func, "glVertexAttrib4bv", &["glVertexAttrib4bvARB"]));
_VertexAttrib4d = transmute(load(func, "glVertexAttrib4d", &["glVertexAttrib4dARB", "glVertexAttrib4dNV"]));
_VertexAttrib4dv = transmute(load(func, "glVertexAttrib4dv", &["glVertexAttrib4dvARB", "glVertexAttrib4dvNV"]));
_VertexAttrib4f = transmute(load(func, "glVertexAttrib4f", &["glVertexAttrib4fARB", "glVertexAttrib4fNV"]));
_VertexAttrib4fv = transmute(load(func, "glVertexAttrib4fv", &["glVertexAttrib4fvARB", "glVertexAttrib4fvNV"]));
_VertexAttrib4iv = transmute(load(func, "glVertexAttrib4iv", &["glVertexAttrib4ivARB"]));
_VertexAttrib4s = transmute(load(func, "glVertexAttrib4s", &["glVertexAttrib4sARB", "glVertexAttrib4sNV"]));
_VertexAttrib4sv = transmute(load(func, "glVertexAttrib4sv", &["glVertexAttrib4svARB", "glVertexAttrib4svNV"]));
_VertexAttrib4ubv = transmute(load(func, "glVertexAttrib4ubv", &["glVertexAttrib4ubvARB"]));
_VertexAttrib4uiv = transmute(load(func, "glVertexAttrib4uiv", &["glVertexAttrib4uivARB"]));
_VertexAttrib4usv = transmute(load(func, "glVertexAttrib4usv", &["glVertexAttrib4usvARB"]));
_VertexAttribBinding = transmute(load(func, "glVertexAttribBinding", &[]));
_VertexAttribDivisor = transmute(load(func, "glVertexAttribDivisor", &["glVertexAttribDivisorANGLE", "glVertexAttribDivisorARB", "glVertexAttribDivisorEXT", "glVertexAttribDivisorNV"]));
_VertexAttribFormat = transmute(load(func, "glVertexAttribFormat", &[]));
_VertexAttribI1i = transmute(load(func, "glVertexAttribI1i", &["glVertexAttribI1iEXT"]));
_VertexAttribI1iv = transmute(load(func, "glVertexAttribI1iv", &["glVertexAttribI1ivEXT"]));
_VertexAttribI1ui = transmute(load(func, "glVertexAttribI1ui", &["glVertexAttribI1uiEXT"]));
_VertexAttribI1uiv = transmute(load(func, "glVertexAttribI1uiv", &["glVertexAttribI1uivEXT"]));
_VertexAttribI2i = transmute(load(func, "glVertexAttribI2i", &["glVertexAttribI2iEXT"]));
_VertexAttribI2iv = transmute(load(func, "glVertexAttribI2iv", &["glVertexAttribI2ivEXT"]));
_VertexAttribI2ui = transmute(load(func, "glVertexAttribI2ui", &["glVertexAttribI2uiEXT"]));
_VertexAttribI2uiv = transmute(load(func, "glVertexAttribI2uiv", &["glVertexAttribI2uivEXT"]));
_VertexAttribI3i = transmute(load(func, "glVertexAttribI3i", &["glVertexAttribI3iEXT"]));
_VertexAttribI3iv = transmute(load(func, "glVertexAttribI3iv", &["glVertexAttribI3ivEXT"]));
_VertexAttribI3ui = transmute(load(func, "glVertexAttribI3ui", &["glVertexAttribI3uiEXT"]));
_VertexAttribI3uiv = transmute(load(func, "glVertexAttribI3uiv", &["glVertexAttribI3uivEXT"]));
_VertexAttribI4bv = transmute(load(func, "glVertexAttribI4bv", &["glVertexAttribI4bvEXT"]));
_VertexAttribI4i = transmute(load(func, "glVertexAttribI4i", &["glVertexAttribI4iEXT"]));
_VertexAttribI4iv = transmute(load(func, "glVertexAttribI4iv", &["glVertexAttribI4ivEXT"]));
_VertexAttribI4sv = transmute(load(func, "glVertexAttribI4sv", &["glVertexAttribI4svEXT"]));
_VertexAttribI4ubv = transmute(load(func, "glVertexAttribI4ubv", &["glVertexAttribI4ubvEXT"]));
_VertexAttribI4ui = transmute(load(func, "glVertexAttribI4ui", &["glVertexAttribI4uiEXT"]));
_VertexAttribI4uiv = transmute(load(func, "glVertexAttribI4uiv", &["glVertexAttribI4uivEXT"]));
_VertexAttribI4usv = transmute(load(func, "glVertexAttribI4usv", &["glVertexAttribI4usvEXT"]));
_VertexAttribIFormat = transmute(load(func, "glVertexAttribIFormat", &[]));
_VertexAttribIPointer = transmute(load(func, "glVertexAttribIPointer", &["glVertexAttribIPointerEXT"]));
_VertexAttribL1d = transmute(load(func, "glVertexAttribL1d", &["glVertexAttribL1dEXT"]));
_VertexAttribL1dv = transmute(load(func, "glVertexAttribL1dv", &["glVertexAttribL1dvEXT"]));
_VertexAttribL2d = transmute(load(func, "glVertexAttribL2d", &["glVertexAttribL2dEXT"]));
_VertexAttribL2dv = transmute(load(func, "glVertexAttribL2dv", &["glVertexAttribL2dvEXT"]));
_VertexAttribL3d = transmute(load(func, "glVertexAttribL3d", &["glVertexAttribL3dEXT"]));
_VertexAttribL3dv = transmute(load(func, "glVertexAttribL3dv", &["glVertexAttribL3dvEXT"]));
_VertexAttribL4d = transmute(load(func, "glVertexAttribL4d", &["glVertexAttribL4dEXT"]));
_VertexAttribL4dv = transmute(load(func, "glVertexAttribL4dv", &["glVertexAttribL4dvEXT"]));
_VertexAttribLFormat = transmute(load(func, "glVertexAttribLFormat", &[]));
_VertexAttribLPointer = transmute(load(func, "glVertexAttribLPointer", &["glVertexAttribLPointerEXT"]));
_VertexAttribP1ui = transmute(load(func, "glVertexAttribP1ui", &[]));
_VertexAttribP1uiv = transmute(load(func, "glVertexAttribP1uiv", &[]));
_VertexAttribP2ui = transmute(load(func, "glVertexAttribP2ui", &[]));
_VertexAttribP2uiv = transmute(load(func, "glVertexAttribP2uiv", &[]));
_VertexAttribP3ui = transmute(load(func, "glVertexAttribP3ui", &[]));
_VertexAttribP3uiv = transmute(load(func, "glVertexAttribP3uiv", &[]));
_VertexAttribP4ui = transmute(load(func, "glVertexAttribP4ui", &[]));
_VertexAttribP4uiv = transmute(load(func, "glVertexAttribP4uiv", &[]));
_VertexAttribPointer = transmute(load(func, "glVertexAttribPointer", &["glVertexAttribPointerARB"]));
_VertexBindingDivisor = transmute(load(func, "glVertexBindingDivisor", &[]));
_VertexP2ui = transmute(load(func, "glVertexP2ui", &[]));
_VertexP2uiv = transmute(load(func, "glVertexP2uiv", &[]));
_VertexP3ui = transmute(load(func, "glVertexP3ui", &[]));
_VertexP3uiv = transmute(load(func, "glVertexP3uiv", &[]));
_VertexP4ui = transmute(load(func, "glVertexP4ui", &[]));
_VertexP4uiv = transmute(load(func, "glVertexP4uiv", &[]));
_Viewport = transmute(load(func, "glViewport", &[]));
_ViewportArrayv = transmute(load(func, "glViewportArrayv", &["glViewportArrayvNV", "glViewportArrayvOES"]));
_ViewportIndexedf = transmute(load(func, "glViewportIndexedf", &["glViewportIndexedfOES", "glViewportIndexedfNV"]));
_ViewportIndexedfv = transmute(load(func, "glViewportIndexedfv", &["glViewportIndexedfvOES", "glViewportIndexedfvNV"]));
_WaitSync = transmute(load(func, "glWaitSync", &["glWaitSyncAPPLE"]));
}