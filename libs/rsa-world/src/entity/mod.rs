...
use crate::{
	...
	iter_components,
	rpc::WorldAPI,
	ChunkStorage, EntityType, EntityPacket,
};
...
impl EntityStorage {
	...
	pub fn push(&mut self, rpc: &WorldAPI, id: Id<EntityType>) -> Entity {
		self.world.spawn(&rpc.entity[id].template)
	}

	pub fn insert(&mut self, rpc: &WorldAPI, entity: Entity, id: Id<EntityType>) {
